...
import { FiCheckCircle, FiActivity, FiUserCheck, FiClock, FiAward, FiPlay, FiChevronDown, FiChevronUp, FiPhone, FiCalendar, FiMessageSquare, FiMail, FiMapPin, FiHeart, FiShield, FiTarget, FiTrendingUp, FiUsers, FiArrowRight, FiBookOpen, FiChevronLeft, FiChevronRight, FiFileText, FiHome, FiGlobe } from 'react-icons/fi';
...
/**
 * Hyderabad-focused Condition Page Template
 *
 * @param {Object} config - Page configuration object
 * @param {string} config.conditionName - Name of the condition (e.g., "Breast Cancer")
 * @param {string} config.keyword - Main SEO keyword (e.g., "breast cancer treatment in Hyderabad")
 * @param {string} config.heroImage - Path to hero section image
 * @param {string} config.conditionImage - Path to condition detail image
 * @param {string} config.description - Brief description of the condition
 * @param {string} config.overview - Detailed overview of the condition
 * @param {Array} config.treatments - Array of treatment options with {title, desc, icon}
 * @param {Array} config.facilities - Array of facilities with {title, desc}
 * @param {Array} config.whyChoose - Array of reasons to choose treatment in Hyderabad
 * @param {Array} config.faqs - Array of FAQ objects with {question, answer}
 * @param {number} config.quoteId - ID for survivor quote
 * @param {string} config.seoPage - SEO page identifier
 */
const HyderabadConditionTemplate = ({ config }) => {
        ...
        <div className="min-h-screen bg-white font-sans text-gray-800">
            ...
            <section className="relative pt-28 pb-16 lg:pt-40 lg:pb-24 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <img
                        ...
                        alt={`${config.conditionName} Treatment in Hyderabad`}
                    ...
                    <div className="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            <span className="inline-block py-1 px-3 rounded-full bg-medical-blue/10 text-medical-blue text-sm font-semibold mb-4">
                                Advanced {config.conditionName} Care in Hyderabad
                            </span>
                            <h1 className="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Best <span className="text-medical-blue">{config.conditionName} Treatment in Hyderabad</span>
                            </h1>
                    ...
                    <div className="bg-white/60 backdrop-blur-xl rounded-2xl border border-white/50 shadow-xl p-6">
                        <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-center md:text-left">
                            ...
                            >
                                ...
                                <p className="text-gray-600 text-sm font-medium">{config.conditionName} Specialist</p>
                            </motion.div>
                            <motion.div
                                initial={{ opacity: 0, scale: 0.9 }}
                                whileInView={{ opacity: 1, scale: 1 }}
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">
                            Comprehensive {config.conditionName} Treatment in Hyderabad
                        </h2>
                        <p className="text-gray-600 text-lg">
                            Experience world-class {config.keyword} with advanced technologies, personalized care, and proven success rates at Apollo Cancer Centres, Hyderabad.
                        </p>
                    </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                {config.treatments.map((treatment, idx) => (
                                    <div key={idx} className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                        <div className="bg-medical-blue/10 p-3 rounded-lg text-medical-blue mt-1">{treatment.icon}</div>
                                        <div>
                                            <h4 className="font-bold text-medical-dark">{treatment.title}</h4>
                    ...
                    <div className="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        ...
                        <p className="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Get expert guidance on the best {config.keyword}. Book a personalized consultation with Dr. Vijay Anand Reddy in Hyderabad today.
                        </p>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mb-8 leading-relaxed">
                                Based in Jubilee Hills, Hyderabad, Dr. Reddy's clinic offers comprehensive cancer care with cutting-edge technology, making him the first choice for patients seeking the best {config.keyword}.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-medical-dark">Hyderabad Based</h4>
                                        <p className="text-xs text-gray-500">Jubilee Hills Location</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-full bg-medical-blue/10 flex items-center justify-center text-medical-blue">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-medical-dark">Pioneer in Hyderabad</h4>
            ...
            <section className="py-16 bg-medical-light">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">
                            {config.conditionName} Treatment at Apollo Hyderabad
                        </h2>
                        <p className="text-gray-600 text-lg">
                            State-of-the-art facilities for {config.keyword} at Apollo Cancer Centres, Jubilee Hills, Hyderabad.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {config.facilities.map((facility, idx) => (
                            <div key={idx} className="bg-white p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <h4 className="font-bold text-medical-dark mb-3">{facility.title}</h4>
                    ...
                    <div className="text-center max-w-4xl mx-auto mb-12">
                        ...
                        >
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                                Hyderabad's Most Reviewed <span className="text-medical-blue">{config.conditionName} Specialist</span>
                            </h2>
                            <p className="text-gray-600 text-lg">
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-gray-600 mb-6 text-center">
                            Common questions about {config.keyword} and treatment at Apollo Hyderabad.
                        </p>
...
export default HyderabadConditionTemplate;
