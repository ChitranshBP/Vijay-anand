...
const OcularOncologyPage = () => {
    ...
    const faqs = [
        ...
        {
            question: "Why is Dr. Vijay Anand Reddy considered a top Ocular Oncologist in India?",
        ...
        {
            question: "What makes Apollo the best for Ocular Oncology in India?",
            answer: "Apollo Cancer Centres provides top-tier Ocular Oncology in India, equipped with Proton Therapy and CyberKnife. We follow global protocols, have a multidisciplinary tumor board, and offer comprehensive support services, ensuring world-class care at a fraction of the cost compared to the West."
        },
        {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-gray-800">
                    ...
                    <div className="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            ...
                            <h1 className="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Leading <span className="text-medical-blue">Ocular Oncology</span> in India
                            </h1>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Looking for the best <strong>Ocular Oncology in India</strong>? Dr. Vijay Anand Reddy offers precise, effective, and patient-centric radiation therapy using the latest global technologies like Proton Therapy, CyberKnife, and Tomotherapy at Apollo Cancer Centres Hyderabad.
                            </p>
                    ...
                    <div className="bg-white/60 backdrop-blur-xl rounded-2xl border border-white/50 shadow-xl p-6">
                        <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-center md:text-left">
                            ...
                            >
                                ...
                                <p className="text-gray-600 text-sm font-medium">Ocular Oncology Expert</p>
                            </motion.div>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">World-Class Ocular Oncology in India</h2>
                        <p className="text-gray-600 text-lg">
                            Experience the pinnacle of cancer care with cutting-edge radiation technologies and the expertise of Dr. Vijay Anand Reddy. For world-class <strong>Ocular Oncology in India</strong>, we deliver precise treatments with minimal side effects.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Ocular Oncology has evolved rapidly, offering cures with fewer side effects. Dr. Vijay Anand Reddy utilizes advanced techniques like <strong>Proton Therapy</strong> and <strong>CyberKnife</strong> to target tumors with sub-millimeter accuracy, preserving healthy organs and ensuring a better quality of life for patients.
                            </p>
                    ...
                    <div className="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        ...
                        <p className="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Get expert guidance on the most advanced radiation treatments. Book a personalized consultation to discuss the best radiotherapy options for your condition with the best Ocular Oncology in India.
                        </p>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                                <img
                                    ...
                                    alt="Dr. Vijay Anand Reddy - Best Ocular Oncologist in India"
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished <strong>Ocular Oncologist</strong> with over 30 years of experience. As the Director of Apollo Cancer Centres, Hyderabad, he has been instrumental in establishing the most comprehensive facility for <strong>Ocular Oncology in India</strong>.
                            </p>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Advanced Ocular Oncology at Apollo Cancer Centres India</h2>
                        <p className="text-gray-600 text-lg">
                            We provide the most advanced <strong>Ocular Oncology in India</strong>, offering the full spectrum of radiotherapy services under one roof.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 mb-12">
                        ...
                        <div className="relative h-full min-h-[400px]">
                            <img
                                ...
                                alt="Advanced Ocular Oncology Technology"
                                className="rounded-2xl shadow-xl w-full h-full object-cover"
                            />
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="lg:w-1/2">
                            <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-6">
                                Why Choose Dr. Vijay Anand Reddy for Ocular Oncology?
                            </h2>
                            ...
                            <ul className="space-y-4">
                                {[
                                    "Director of Apollo Cancer Centres & Senior Consultant Ocular Oncologist",
                                    "Pioneered IMRT, IGRT, and Stereotactic Radiosurgery in the region",
                                    "Specially trained in Proton Therapy and CyberKnife",
                                    "President of Association of Ocular Oncologists of India (Past)",
                    ...
                    <div className="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                            Experience World-Class Ocular Oncology Care
                        </h3>
                        <p className="text-white text-lg mb-6 max-w-2xl mx-auto">
                    ...
                    <div className="text-center max-w-4xl mx-auto mb-12">
                        ...
                        >
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                                Most Reviewed & Highest Rated <span className="text-medical-blue">Ocular Oncologist in India</span>
                            </h2>
                            <p className="text-gray-600 text-lg">
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">
                            Ocular Oncology Patient Video Testimonials
                        </h2>
                        <p className="text-gray-600 text-lg">
            ...
            <section className="py-14">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-8 text-center">Frequently Asked Questions About Ocular Oncology</h2>
                        <p className="text-gray-600 mb-6 text-center">
                            Get answers to common questions about radiation therapy, technologies, costs, and what to expect from the best Ocular Oncology in India.
                        </p>
...
export default OcularOncologyPage;
