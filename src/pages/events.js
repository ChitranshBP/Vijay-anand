export const eventCategories = [
  { key: 'women', name: 'Events for Women' },
  { key: 'children', name: 'Events for Children' },
  { key: 'anti-tobacco', name: 'Anti Tobacco Programmes' },
  { key: 'world-cancer-day', name: 'World Cancer Day' },
  { key: 'cancer-survivor-day', name: 'Cancer Survivor Day' },
    { key: 'awareness-programmes', name: 'Awareness Programmes' }
