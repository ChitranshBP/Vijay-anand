    ...
    return (
        <div className="min-h-screen bg-white font-sans text-gray-800">
                    ...
                    <div className="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            ...
                            <h1 className="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Best <span className="text-medical-blue">SRS Cost</span> in India
                            </h1>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Advanced SRS Cancer Treatment in India</h2>
                    ...
                    <div className="mt-12 bg-medical-light p-8 rounded-2xl border border-medical-blue/20">
                        <h3 className="text-2xl font-bold text-medical-dark mb-6 text-center">SRS Cost in India - Transparent Pricing</h3>
            ...
            <section className="py-14 bg-medical-light">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Our SRS Treatment Process</h2>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">SRS at Apollo Cancer Centres India</h2>
                        <p className="text-gray-600 text-lg">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 mb-12">
                        <div>
                            <h3 className="text-2xl font-bold text-medical-dark mb-6 flex items-center gap-3">
                                <FaHospital className="text-medical-blue" /> About Apollo SRS Center
                            </h3>
                            <p className="text-gray-600 mb-6 leading-relaxed">
                    ...
                    <div className="mt-12">
                        <h3 className="text-2xl font-bold text-medical-dark mb-8 text-center">Advanced SRS Facilities & Equipment</h3>
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <h4 className="font-bold text-medical-dark mb-3">Latest SRS Drugs</h4>
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-4xl mx-auto mb-12">
                        ...
                        >
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                                Most Reviewed & Highest Rated <span className="text-medical-blue">SRS Doctor in India</span>
                            </h2>
                            <p className="text-gray-600 text-lg">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                        ...
                        >
                            ...
                            <p className="text-xs text-gray-500 mt-1">For SRS</p>
                        </motion.div>
                    </div>
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">
                            SRS Patient Video Testimonials
                        </h2>
                        <p className="text-gray-600 text-lg">
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-gray-600 mb-6 text-center">
                            Get answers to common questions about SRS treatment, costs, side effects, and what to expect from India's best SRS doctor, Dr. Vijay Anand Reddy.
                        </p>
