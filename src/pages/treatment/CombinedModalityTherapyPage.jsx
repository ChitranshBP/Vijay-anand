...
const CombinedModalityTherapyPage = () => {
    ...
    const faqs = [
        {
            question: "What is Combined Modality Therapy?",
            answer: "Combined Modality Therapy treatment in Hyderabad delivers extremely focused, high-dose radiation to brain and spine tumors in 1-5 sessions with submillimeter accuracy. Dr. Vijay Anand Reddy, with specialized SRS fellowship training from Germany, uses advanced systems at Apollo Cancer Centres for brain metastases, AVMs, acoustic neuromas, meningiomas, and spinal tumors."
        },
        {
            question: "How much does SRS treatment cost in Hyderabad?",
            answer: "Combined Modality Therapy costs ₹1.5-4 lakhs, significantly more affordable than Western countries (65% lower cost). The cost includes advanced imaging, precise planning, and single or few-session delivery. Dr. Reddy provides transparent pricing and works with insurance providers for SRS procedures."
        },
        {
                    ...
                    <div className="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Experience cutting-edge <strong>Combined Modality Therapy</strong> with Dr. Vijay Anand Reddy at Apollo Cancer Centres. With specialized fellowship training from Germany, we deliver submillimeter-accurate stereotactic radiosurgery for brain and spine tumors at 65% lower cost than Western countries.
                            </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                <strong>Combined Modality Therapy</strong> uses highly focused radiation beams that converge on brain or spine tumors with submillimeter precision. Despite the name "radiosurgery," no incision is made. Dr. Vijay Anand Reddy completed specialized SRS fellowship training at Klinikum Frankfurt, Germany and uses frameless image-guided systems for comfortable, accurate treatment. With 65% cost savings, Hyderabad offers world-class SRS technology.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">100% accuracy</p>
                                    </div>
                                </div>
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                    ...
                    <div className="mt-12 bg-medical-light p-8 rounded-2xl border border-medical-blue/20">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="bg-white p-6 rounded-xl shadow-sm">
                                ...
                                <div className="text-3xl font-bold text-medical-blue mb-2">Variable</div>
                                <p className="text-sm text-gray-600">Single tumor treatment</p>
                            </div>
                            <div className="bg-white p-6 rounded-xl shadow-sm">
                                <h4 className="font-bold text-medical-dark mb-3">Complex Cases</h4>
                                <div className="text-3xl font-bold text-medical-blue mb-2">Varies</div>
