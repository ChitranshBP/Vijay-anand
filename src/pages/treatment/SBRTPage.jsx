...
const SBRTPage = () => {
    ...
    const faqs = [
        {
            question: "What is SBRT Treatment in Hyderabad?",
            answer: "SBRT (Stereotactic Body Radiation Therapy) treatment in Hyderabad delivers extremely focused, high-dose radiation to body tumors in 1-5 sessions with submillimeter accuracy. Dr. Vijay Anand Reddy, with specialized SRS fellowship training from Germany, uses advanced systems at Apollo Cancer Centres for brain metastases, AVMs, acoustic neuromas, meningiomas, and spinal tumors."
        },
        {
            question: "How much does SRS treatment cost in Hyderabad?",
            answer: "SBRT Treatment in Hyderabad costs ₹1.5-4 lakhs, significantly more affordable than Western countries (68% lower cost). The cost includes advanced imaging, precise planning, and single or few-session delivery. Dr. Reddy provides transparent pricing and works with insurance providers for SRS procedures."
        },
        {
                    ...
                    <div className="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Experience cutting-edge <strong>SBRT Treatment in Hyderabad</strong> with Dr. Vijay Anand Reddy at Apollo Cancer Centres. With specialized fellowship training from Germany, we deliver submillimeter-accurate stereotactic radiosurgery for body tumors at 68% lower cost than Western countries.
                            </p>

                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="bg-white p-4 rounded-lg border border-medical-blue/20 shadow-sm">
                                    <div className="text-3xl font-bold text-medical-blue mb-1">68%</div>
                                    <p className="text-xs text-gray-600">Cost Savings vs USA</p>
                                </div>
                                <div className="bg-white p-4 rounded-lg border border-medical-blue/20 shadow-sm">
                                    <div className="text-3xl font-bold text-medical-blue mb-1">1mm</div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                <strong>SBRT Treatment in Hyderabad</strong> uses highly focused radiation beams that converge on brain or spine tumors with submillimeter precision. Despite the name "radiosurgery," no incision is made. Dr. Vijay Anand Reddy completed specialized SRS fellowship training at Klinikum Frankfurt, Germany and uses frameless image-guided systems for comfortable, accurate treatment. With 68% cost savings, Hyderabad offers world-class SRS technology.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">1mm accuracy</p>
                                    </div>
                                </div>
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
