            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">
                            External Beam Radiation Therapy Patient Video Testimonials
                        </h2>
                        <p className="text-gray-600 text-lg">
            ...
            <section className="py-14">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-8 text-center">Frequently Asked Questions About External Beam Radiation Therapy</h2>
                        <p className="text-gray-600 mb-6 text-center">
                            Get answers to common questions about external beam radiation therapy treatment, costs, side effects, and what to expect from India's best external beam radiation therapy doctor, Dr. Vijay Anand Reddy.
                        </p>
