            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <p className="text-gray-600 text-lg">
                            We provide comprehensive support for international patients, ensuring a seamless and comfortable treatment journey in India.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Initial video consultation to discuss treatment options and eligibility before travel."
                            },
                            {
                                icon: <FiFileText size={32} />,
                                title: "Visa Assistance",
                                desc: "Full support with medical visa invitation letters and travel documentation."
                            },
                            {
                                icon: <FiHome size={32} />,
                                title: "Accommodation",
                                desc: "Assistance with finding comfortable stay options near the hospital for you and your family."
                            },
                            {
                                icon: <FiGlobe size={32} />,
                                title: "Interpreter Services",
                                desc: "Language interpretation support to ensure clear communication throughout your treatment."
                            }
                        ].map((service, idx) => (
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                            <div className="text-white max-w-xl">
                                ...
                                <p className="text-blue-100 text-lg mb-6">
                                    Our dedicated International Patient Care team is available 24/7 to assist you with treatment planning, cost estimates, and travel arrangements.
                                </p>
