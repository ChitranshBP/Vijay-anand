...
const PancreaticCancerIndiaPage = () => {
    ...
    const faqs = [
        {
            question: "Who is the best Pancreatic Cancer doctor in India?",
            answer: "Dr. Vijay Anand Reddy is widely recognized as one of the best Pancreatic Cancer doctors in India, known for his expertise in advanced oncology treatments, international training, and compassionate patient care. With over 30 years of experience and access to state-of-the-art technology at Apollo Cancer Centres, he provides world-class treatment."
        },
        {
            question: "What are the advanced treatments available for Pancreatic Cancer in India?",
            answer: "India offers world-class treatments including Whipple surgery (pancreaticoduodenectomy), minimally invasive robotic surgery, stereotactic body radiation therapy (SBRT), targeted chemotherapy, immunotherapy, and precision medicine approaches. Dr. Vijay Anand Reddy utilizes these advanced protocols and personalized treatment plans for the best outcomes."
        },
        {
            question: "How do I choose the top doctor for Pancreatic Cancer in India?",
            answer: "Look for a specialist with extensive experience in complex pancreatic surgeries, international certifications (like ESMO), a high success rate in Whipple procedures, access to advanced technology including robotic surgery, and a multidisciplinary team approach. Dr. Vijay Anand Reddy meets all these criteria and has successfully treated thousands of patients."
        },
        {
            question: "Is pancreatic cancer curable?",
            answer: "If detected early (Stage I or II), pancreatic cancer is treatable and potentially curable with surgery followed by adjuvant therapies. Advanced treatments including robotic surgery, targeted therapy, and immunotherapy have significantly improved survival rates. Even in advanced stages, treatment can extend life and improve quality of life."
        },
        {
            question: "What is the recovery time after pancreatic cancer surgery?",
            answer: "Recovery from pancreatic cancer surgery (Whipple procedure) typically involves a hospital stay of 1-2 weeks, followed by 6-8 weeks for initial recovery and 3-6 months for full recovery. Dr. Vijay Anand Reddy's team provides comprehensive post-operative care, nutritional support, and rehabilitation to optimize recovery and minimize complications."
        },
        {
            question: "What are the survival rates for pancreatic cancer?",
            answer: "Survival rates depend on the stage at diagnosis. For localized pancreatic cancer (detected early), the 5-year survival rate can be 30-40% with proper treatment. With Dr. Vijay Anand Reddy's advanced surgical techniques and comprehensive care approach, patients achieve better outcomes than national averages."
        },
        {
            question: "How soon can I start pancreatic cancer treatment?",
            answer: "After your initial consultation with Dr. Vijay Anand Reddy, diagnostic tests and staging typically take 1-2 weeks. Once the treatment plan is finalized, surgery or other treatments can begin immediately. We prioritize urgent cases and work efficiently to start treatment as soon as medically appropriate, as timing is crucial for pancreatic cancer."
        }
    ];

    const videos = [
        { id: 1, title: "Pancreatic Cancer Success Story", videoId: "dQw4w9WgXcQ", thumbnail: "https://img.youtube.com/vi/dQw4w9WgXcQ/hqdefault.jpg" },
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        ...
                        >
                            ...
                            <h1 className="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Best <span className="text-medical-blue">Pancreatic Cancer Doctor</span> in India
                            </h1>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Seeking the <strong>top doctor for Pancreatic Cancer in India</strong>? Dr. Vijay Anand Reddy offers internationally acclaimed expertise, advanced robotic surgeries, and personalized care plans for superior clinical outcomes.
                            </p>
                            ...
                            <div className="bg-medical-light p-6 rounded-xl mb-6 border border-medical-blue/20">
                                <h3 className="font-bold text-medical-dark mb-4 flex items-center gap-2">
                                    <FiCheckCircle className="text-medical-blue" /> Why Choose Our Pancreatic Cancer Treatment?
                                </h3>
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3 text-gray-700">
                                        <FiCheckCircle className="text-medical-blue mt-1 flex-shrink-0" size={18} />
                                        <span className="text-sm"><strong>Advanced Robotic Surgery</strong> - Minimally invasive Whipple procedures</span>
                                    </li>
                                    <li className="flex items-start gap-3 text-gray-700">
                                        <FiCheckCircle className="text-medical-blue mt-1 flex-shrink-0" size={18} />
                                        <span className="text-sm"><strong>Multidisciplinary Team</strong> - Oncologists, surgeons, and support specialists</span>
                                    </li>
                                    <li className="flex items-start gap-3 text-gray-700">
                                        <FiCheckCircle className="text-medical-blue mt-1 flex-shrink-0" size={18} />
                                        <span className="text-sm"><strong>Personalized Treatment</strong> - Customized plans based on cancer stage and genetics</span>
                                    </li>
                                    <li className="flex items-start gap-3 text-gray-700">
                                        <FiCheckCircle className="text-medical-blue mt-1 flex-shrink-0" size={18} />
                                        <span className="text-sm"><strong>Comprehensive Care</strong> - From diagnosis to recovery and beyond</span>
                                    </li>
                                </ul>
                            </div>
                        ...
                        >
                            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                                <img
                                    ...
                                    alt="Best Pancreatic Cancer Doctor in India - Dr. Vijay Anand Reddy"
                    ...
                    <div className="bg-white/60 backdrop-blur-xl rounded-2xl border border-white/50 shadow-xl p-6">
                        <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-center md:text-left">
                            ...
                            >
                                ...
                                <p className="text-gray-600 text-sm font-medium">Pancreatic Cancer Expert</p>
                            </motion.div>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Advanced Pancreatic Cancer Treatment</h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Pancreatic cancer is a malignancy arising in the pancreas. It requires highly specialized care due to the organ's complex location. Dr. Vijay Anand Reddy, a <strong>Pancreatic Cancer doctor in India</strong>, specializes in treating both exocrine and neuroendocrine tumors using the latest global protocols.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                <div className="bg-gradient-to-br from-blue-50 to-white p-4 rounded-lg border border-blue-100 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Complex surgical resection.</p>
                                    </div>
                                </div>
                                <div className="bg-gradient-to-br from-purple-50 to-white p-4 rounded-lg border border-purple-100 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-medical-dark">Robotic Surgery</h4>
                                        <p className="text-sm text-gray-500">Minimally invasive precision.</p>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-orange-50 to-white p-4 rounded-lg border border-orange-100 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Boosting body's defense.</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-md">
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    "Diabetes (especially sudden onset)",
                ...
                <div className="container mx-auto px-4">
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1 bg-blue-50 p-8 rounded-2xl border border-blue-100">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">4-8 hours procedure, 1-2 weeks hospital stay.</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">5-6 weeks of daily sessions.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-1 bg-green-50 p-8 rounded-2xl border border-green-100">
                            ...
                            <ul className="space-y-2">
                                <li className="flex items-start gap-2 text-gray-700 text-sm">
                                    <FiCheckCircle className="text-green-500 mt-1 flex-shrink-0" /> Maintain a balanced, nutritious diet.
                                </li>
                                <li className="flex items-start gap-2 text-gray-700 text-sm">
                                    <FiCheckCircle className="text-green-500 mt-1 flex-shrink-0" /> Stay hydrated and active as tolerated.
                                </li>
                                <li className="flex items-start gap-2 text-gray-700 text-sm">
                                    <FiCheckCircle className="text-green-500 mt-1 flex-shrink-0" /> Follow medication schedules strictly.
                                </li>
                                <li className="flex items-start gap-2 text-gray-700 text-sm">
                        ...
                        <div className="lg:col-span-1 bg-red-50 p-8 rounded-2xl border border-red-100">
                            ...
                            <ul className="space-y-2">
                                <li className="flex items-start gap-2 text-gray-700 text-sm">
                                    <FiXCircle className="text-red-500 mt-1 flex-shrink-0" /> Ignore new or worsening symptoms.
                                </li>
                                <li className="flex items-start gap-2 text-gray-700 text-sm">
                                    <FiXCircle className="text-red-500 mt-1 flex-shrink-0" /> Consume alcohol or tobacco.
                                </li>
                                <li className="flex items-start gap-2 text-gray-700 text-sm">
                                    <FiXCircle className="text-red-500 mt-1 flex-shrink-0" /> Skip meals or eat heavy, fatty foods.
                                </li>
                                <li className="flex items-start gap-2 text-gray-700 text-sm">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        {[
                            ...
                            { step: "02", title: "Staging", desc: "PET-CT and biopsy to determine cancer stage.", image: "https://img.freepik.com/free-photo/doctor-analyzing-x-ray-scan_1421-67.jpg" },
                            ...
                            { step: "04", title: "Treatment", desc: "Execution of surgery, chemo, or radiation.", image: "https://img.freepik.com/free-photo/surgeons-operating-room_1421-69.jpg" }
                        ].map((item, idx) => (
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="lg:w-1/2">
                            ...
                            <ul className="space-y-4">
                                {[
                                    "Best Pancreatic Cancer doctor in India with 30+ years experience",
                                    "Expertise in complex Whipple & Robotic Surgeries",
                                    "Access to latest Clinical Trials & Immunotherapy",
...
export default PancreaticCancerIndiaPage;
