...
const HeadNeckSubConditionsPage = () => {
    const videos = [
    ...
    const faqs = [
        {
            question: "What is head and neck cancer treatment in India?",
            answer: "Head and neck cancer treatment in India involves a multidisciplinary approach including surgery, radiation therapy (IMRT, IGRT), chemotherapy, and targeted therapy. Dr. Vijay Anand Reddy provides world-class head and neck cancer treatment in India with advanced technologies and personalized care plans at Apollo Cancer Centres, Hyderabad."
        },
        {
            question: "What are the common subsites of head and neck cancer?",
            answer: "Common subsites include the oral cavity, pharynx (throat), larynx (voice box), salivary glands, paranasal sinuses, and nasal cavity. Dr. Vijay Anand Reddy specializes in treating cancers of all these subsites with precision and care."
        },
        {
            question: "What types of treatment are available for head and neck cancers?",
            answer: "Treatment options include minimally invasive surgery, robotic surgery, IMRT/IGRT radiation, chemotherapy, and immunotherapy. Dr. Vijay Anand Reddy specializes in organ preservation protocols for head and neck cancer treatment in India."
        },
        {
            question: "Why choose Dr. Vijay Anand Reddy for head and neck cancer treatment?",
            answer: "With over 30 years of experience, Dr. Vijay Anand Reddy is a leading expert in head and neck oncology. He utilizes cutting-edge technology like IMRT and IGRT to deliver precise radiation, minimizing side effects and preserving vital functions like speech and swallowing."
        },
        {
            question: "What is the cost of head and neck cancer treatment in India?",
            answer: "Head and neck cancer treatment in India is cost-effective compared to global standards. The cost varies based on the specific subsite, stage, and chosen treatment modality. Dr. Reddy's clinic offers transparent pricing and treatment packages."
        },
        {
            question: "How long does head and neck cancer treatment take?",
            answer: "Treatment duration depends on the plan. Radiation therapy typically lasts 6-7 weeks. Surgery recovery varies but may take a few weeks. Concurrent chemotherapy might be given during radiation. Dr. Vijay Anand Reddy outlines a clear timeline for each patient."
        },
        {
            question: "What is the success rate of head and neck cancer treatment?",
            answer: "Success rates are high, especially with early detection and advanced treatment. Organ preservation rates have significantly improved with modern radiation techniques. Dr. Vijay Anand Reddy strives for the best functional and oncological outcomes."
        }
    ];
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-gray-800">
                    ...
                    <div className="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            <span className="inline-block py-1 px-3 rounded-full bg-medical-blue/10 text-medical-blue text-sm font-semibold mb-4">
                                Advanced Head & Neck Care
                            </span>
                            <h1 className="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Best <span className="text-medical-blue">Head & Neck Cancer Treatment</span> in India
                            </h1>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Seeking world-class <strong>head and neck cancer treatment in India</strong>? Dr. Vijay Anand Reddy offers advanced radiation oncology, precision surgery, and comprehensive cancer care for all head and neck subsites at Apollo Cancer Centres Hyderabad.
                            </p>
                    ...
                    <div className="bg-white/60 backdrop-blur-xl rounded-2xl border border-white/50 shadow-xl p-6">
                        <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-center md:text-left">
                            ...
                            >
                                ...
                                <p className="text-gray-600 text-sm font-medium">Head & Neck Cancer Expert in India</p>
                            </motion.div>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Comprehensive Head & Neck Cancer Treatment in India</h2>
                        <p className="text-gray-600 text-lg">
                            Experience cutting-edge treatment for head and neck cancers including oral, throat, and larynx cancers. Dr. Vijay Anand Reddy offers the best outcomes with advanced organ preservation protocols.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Head and neck cancers encompass a range of tumors affecting the mouth, throat, voice box, and sinuses. Dr. Vijay Anand Reddy, a leading specialist in <strong>head and neck cancer treatment in India</strong>, offers comprehensive care tailored to preserving speech and swallowing functions.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Endoscopy & PET-CT</p>
                                    </div>
                                </div>
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    <div className="bg-medical-blue/10 p-3 rounded-lg text-medical-blue mt-1"><FaProcedures size={24} /></div>
                                    <div>
                                        <h4 className="font-bold text-medical-dark">Organ Preservation</h4>
                                        <p className="text-sm text-gray-500">Non-surgical options</p>
                                    </div>
                                </div>
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">IMRT & VMAT</p>
                                    </div>
                                </div>
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                    ...
                    <div className="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                            Schedule Your Head & Neck Cancer Consultation
                        </h3>
                        <p className="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Get expert guidance on the best eye cancer treatment in India. Book a personalized consultation to discuss your treatment options and customized care plan.
                        </p>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                                <img
                                    ...
                                    alt="Dr. Vijay Anand Reddy - Best Head & Neck Cancer Treatment Doctor in India"
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished radiation oncologist with over 30 years of experience providing world-class <strong>head and neck cancer treatment in India</strong>. As the Director of Apollo Cancer Centres, Hyderabad, he has pioneered advanced radiation oncology techniques.
                            </p>
                            <p className="text-gray-600 mb-8 leading-relaxed">
                                He is renowned for his expertise in IMRT, IGRT, and concurrent chemoradiation protocols. His commitment to organ preservation and quality of life makes him one of India's leading head and neck cancer specialists.
                            </p>
            ...
            <section className="py-14 bg-medical-light">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Our Head & Neck Treatment Process</h2>
                        <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                            A systematic, patient-centric approach to head and neck cancer treatment in India. Dr. Vijay Anand Reddy and his team follow a comprehensive 4-step process.
                        </p>
                    </div>
                    ...
                    <div className="mt-12 text-center">
                        <div className="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-medical-blue max-w-4xl mx-auto">
                            ...
                            <p className="text-gray-600 mb-6 text-lg">
                                Don't wait to start your journey to recovery. Dr. Vijay Anand Reddy and our expert team are ready to provide you with the best head and neck cancer treatment in India.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <a href="#book-appointment" className="px-8 py-4 bg-medical-blue text-white rounded-lg font-semibold hover:bg-medical-dark transition shadow-lg flex items-center justify-center gap-2">
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Head & Neck Cancer Treatment at Apollo Cancer Centres India</h2>
                        <p className="text-gray-600 text-lg">
                            State-of-the-art infrastructure for head and neck cancer treatment with world-class facilities, latest technology, and expert care.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 mb-12">
                        <div>
                            <h3 className="text-2xl font-bold text-medical-dark mb-6 flex items-center gap-3">
                                <FaHospital className="text-medical-blue" /> About Apollo Head & Neck Center
                            </h3>
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Apollo Cancer Centres is equipped with India's most advanced head and neck cancer treatment facilities, offering comprehensive cancer care. Under the leadership of Dr. Vijay Anand Reddy, our center provides world-class <strong>head and neck cancer treatment in India</strong>.
                            </p>
                            <p className="text-gray-600 mb-6 leading-relaxed">
                            ...
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20">
                                ...
                                <ul className="space-y-2">
                                    <li className="flex items-start gap-2 text-gray-700 text-sm">
                                        ...
                                        Advanced endoscopy and biopsies
                                    </li>
                                    <li className="flex items-start gap-2 text-gray-700 text-sm">
                                        <span className="w-1.5 h-1.5 bg-medical-blue rounded-full mt-2 flex-shrink-0"></span>
                        ...
                        <div className="relative h-full min-h-[400px]">
                            <img
                                ...
                                alt="Apollo Cancer Centre Head & Neck Cancer Treatment Facility"
                                className="rounded-2xl shadow-xl w-full h-full object-cover"
                            />
                        </div>
                    </div>
                    ...
                    <div className="mt-12">
                        <h3 className="text-2xl font-bold text-medical-dark mb-8 text-center">Advanced Technology for Head & Neck Cancer</h3>
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    High-resolution imaging and endoscopy for precise tumor mapping and staging.
                                </p>
                            </div>
                            ...
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    Transoral robotic surgery (TORS) and laser surgeries for better functional outcomes.
                                </p>
                            </div>
                            ...
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    IMRT and IGRT to spare salivary glands and critical structures while targeting the tumor.
                                </p>
                            </div>
                            ...
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    Latest systemic therapies including immunotherapy for better survival in advanced cases.
                                </p>
                            </div>
                            ...
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    Speech and swallowing therapy for comprehensive rehabilitation.
                                </p>
                            </div>
            ...
            <section className="py-14 bg-medical-light">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-gray-600 mb-8 text-lg">
                                As a pioneer in head and neck cancer treatment, Dr. Vijay Anand Reddy brings world-class expertise to help you fight cancer while preserving your quality of life.
                            </p>
                            <ul className="space-y-4">
                                {[
                                    "Expert head & neck oncologist with 30+ years experience",
                                    "Specialist in organ-preserving radiation therapy",
                    ...
                    <div className="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                            Experience World-Class Head & Neck Cancer Treatment in India
                        </h3>
                        <p className="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Join thousands of patients who have trusted Dr. Vijay Anand Reddy for advanced head and neck cancer treatment with proven results and compassionate care.
                        </p>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <p className="text-gray-600 text-lg">
                            We provide comprehensive support for international patients seeking affordable and high-quality head and neck cancer treatment in India.
                        </p>
                    </div>
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                            <div className="text-white max-w-xl">
                                ...
                                <p className="text-blue-100 text-lg mb-6">
                                    Our dedicated International Patient Care team is available 24/7 to assist with treatment planning, cost estimates, and travel arrangements for head and neck cancer treatment in India.
                                </p>
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-4xl mx-auto mb-12">
                        ...
                        >
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                                Most Reviewed & Highest Rated <span className="text-medical-blue">Head & Neck Cancer Treatment Doctor in India</span>
                            </h2>
                            <p className="text-gray-600 text-lg">
                                Dr. Vijay Anand Reddy has earned the trust of thousands of patients through exceptional care, advanced treatment techniques, and outstanding clinical outcomes.
                            </p>
                        </motion.div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                        ...
                        >
                            ...
                            <p className="text-xs text-gray-500 mt-1">For Head & Neck Cancer Treatment</p>
                        </motion.div>
                    </div>
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">
                            Head & Neck Cancer Patient Video Testimonials
                        </h2>
                        <p className="text-gray-600 text-lg">
                            Hear from our patients about their successful head and neck cancer treatment journey with Dr. Vijay Anand Reddy.
                        </p>
                    </div>
            ...
            <section className="py-14">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-8 text-center">Frequently Asked Questions About Head & Neck Cancer Treatment in India</h2>
                        <p className="text-gray-600 mb-6 text-center">
                            Get answers to common questions about head and neck cancer treatment, costs, success rates, and what to expect from India's best head and neck cancer treatment doctor, Dr. Vijay Anand Reddy.
                        </p>
...
export default HeadNeckSubConditionsPage;
