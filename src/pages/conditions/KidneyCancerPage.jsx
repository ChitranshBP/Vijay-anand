...
const KidneyCancerPage = () => {
    ...
    const faqs = [
        {
            question: "What is kidney cancer treatment in India?",
            answer: "Kidney cancer treatment in India encompasses comprehensive care including surgery (nephrectomy), targeted therapy, immunotherapy, radiation therapy (SBRT), and ablation techniques. Dr. Vijay Anand Reddy provides world-class kidney cancer treatment in India with advanced technologies and personalized care plans at Apollo Cancer Centres, Hyderabad."
        },
        {
            question: "What are the early signs of kidney cancer?",
            answer: "Early signs include blood in urine (hematuria), persistent flank pain, abdominal mass or lump, unexplained weight loss, fatigue, and intermittent fever. Regular check-ups and imaging are crucial for early detection. If you notice any of these signs, consult Dr. Vijay Anand Reddy for the best kidney cancer treatment in India."
        },
        {
            question: "What types of kidney cancer treatment are available in India?",
            answer: "India offers comprehensive kidney cancer treatment options including partial or radical nephrectomy, targeted therapy, immunotherapy (checkpoint inhibitors), radiation therapy (SBRT), and ablation techniques (radiofrequency or cryoablation). Dr. Vijay Anand Reddy specializes in advanced radiation oncology techniques for kidney cancer treatment in India."
        },
        {
            question: "Why choose Dr. Vijay Anand Reddy for kidney cancer treatment in India?",
            answer: "With over 30 years of experience in radiation oncology, Dr. Vijay Anand Reddy offers world-class kidney cancer treatment in India. He utilizes cutting-edge technology, personalized treatment plans, and a multidisciplinary approach to ensure the best outcomes for kidney cancer patients. His expertise in SBRT and targeted therapies makes him one of India's leading oncologists."
        },
        {
            question: "What is the cost of kidney cancer treatment in India?",
            answer: "Kidney cancer treatment in India is significantly more affordable compared to Western countries, typically 60-70% lower, without compromising on quality. The exact cost depends on the stage of cancer, treatment modality, and duration. Dr. Reddy's clinic offers transparent pricing and treatment packages for kidney cancer treatment in India."
        },
        {
            question: "How long does kidney cancer treatment take in India?",
            answer: "The duration of kidney cancer treatment in India varies based on the stage and type. Surgery may take a few hours with 1-2 weeks recovery, while targeted therapy and immunotherapy can continue for several months. Radiation therapy typically spans 1-2 weeks with SBRT. Dr. Vijay Anand Reddy creates customized treatment timelines for each kidney cancer patient."
        },
        {
            question: "What is the success rate of kidney cancer treatment in India?",
            answer: "Kidney cancer treatment in India has excellent success rates, with early-stage kidney cancer having an 80-90% five-year survival rate. Dr. Vijay Anand Reddy has successfully treated thousands of kidney cancer patients with advanced radiation oncology techniques, targeted therapy, and personalized care, achieving outstanding outcomes comparable to global standards."
        }
    ];
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-gray-800">
                    ...
                    <div className="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            <span className="inline-block py-1 px-3 rounded-full bg-medical-blue/10 text-medical-blue text-sm font-semibold mb-4">
                                Advanced Kidney Cancer Care
                            </span>
                            <h1 className="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Best <span className="text-medical-blue">Kidney Cancer Treatment</span> in India
                            </h1>
                            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                                Seeking world-class <strong>kidney cancer treatment in India</strong>? Dr. Vijay Anand Reddy offers advanced radiation oncology, precision surgery, targeted therapy, and comprehensive cancer care at Apollo Cancer Centres Hyderabad. Get expert treatment with the latest SBRT, immunotherapy, and minimally invasive techniques.
                            </p>

                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="bg-white p-4 rounded-lg border border-medical-blue/20 shadow-sm">
                                    <div className="text-3xl font-bold text-medical-blue mb-1">80-90%</div>
                    ...
                    <div className="bg-white/60 backdrop-blur-xl rounded-2xl border border-white/50 shadow-xl p-6">
                        <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-center md:text-left">
                            ...
                            >
                                ...
                                <p className="text-gray-600 text-sm font-medium">Kidney Cancer Doctor in India</p>
                            </motion.div>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Comprehensive Kidney Cancer Treatment in India</h2>
                        <p className="text-gray-600 text-lg">
                            Experience cutting-edge kidney cancer treatment in India with advanced radiation oncology, precision surgery, targeted therapy, immunotherapy, and personalized care. Dr. Vijay Anand Reddy offers the best outcomes with proven success rates.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Kidney cancer (renal cell carcinoma) begins when cells in the kidney grow out of control. Dr. Vijay Anand Reddy, a leading specialist in <strong>kidney cancer treatment in India</strong>, offers comprehensive care including advanced diagnostics, minimally invasive surgery (nephrectomy), precision radiation therapy (SBRT), targeted therapy, immunotherapy, and ablation techniques tailored to each patient's unique cancer type and stage.
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">CT, MRI & molecular imaging</p>
                                    </div>
                                </div>
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Partial nephrectomy surgery</p>
                                    </div>
                                </div>
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">SBRT therapy</p>
                                    </div>
                                </div>
                                <div className="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                        ...
                        <div className="relative h-full min-h-[400px]">
                            <img
                                ...
                                alt="Kidney Cancer Treatment in India"
                    ...
                    <div className="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                            Schedule Your Kidney Cancer Consultation with Dr. Vijay Anand Reddy
                        </h3>
                        <p className="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Get expert guidance on the best kidney cancer treatment in India. Book a personalized consultation to discuss your treatment options and customized care plan.
                        </p>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                                <img
                                    ...
                                    alt="Dr. Vijay Anand Reddy - Best Kidney Cancer Treatment Doctor in India"
                        ...
                        >
                            ...
                            <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished radiation oncologist with over 30 years of experience providing world-class <strong>kidney cancer treatment in India</strong>. As the Director of Apollo Cancer Centres, Hyderabad, he has pioneered advanced radiation oncology techniques and personalized treatment approaches for kidney cancer patients.
                            </p>
                            <p className="text-gray-600 mb-8 leading-relaxed">
                                He is renowned for his expertise in SBRT, targeted therapy, and immunotherapy for kidney cancer. His commitment to personalized patient care, use of cutting-edge technology, and evidence-based medicine has earned him recognition as one of India's leading kidney cancer specialists.
                            </p>
            ...
            <section className="py-14 bg-medical-light">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Our Kidney Cancer Treatment Process</h2>
                        <p className="text-gray-600 text-lg max-w-3xl mx-auto">
                            A systematic, patient-centric approach to kidney cancer treatment in India. Dr. Vijay Anand Reddy and his team follow a comprehensive 4-step process for optimal treatment outcomes.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        {[
                            ...
                            { step: "03", title: "Treatment Delivery", desc: "Surgery, radiation, targeted therapy, or immunotherapy with precision.", image: "https://img.freepik.com/free-photo/medical-team-meeting_1421-68.jpg" },
                    ...
                    <div className="mt-12 text-center">
                        <div className="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-medical-blue max-w-4xl mx-auto">
                            <h3 className="text-2xl md:text-3xl font-bold text-medical-dark mb-4">
                                Begin Your Kidney Cancer Treatment Journey Today
                            </h3>
                            <p className="text-gray-600 mb-6 text-lg">
                                Don't wait to start your journey to recovery. Dr. Vijay Anand Reddy and our expert team are ready to provide you with the best kidney cancer treatment in India with world-class care.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <a href="#book-appointment" className="px-8 py-4 bg-medical-blue text-white rounded-lg font-semibold hover:bg-medical-dark transition shadow-lg flex items-center justify-center gap-2">
            ...
            {/* Apollo Hospital Kidney Cancer Section */}
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Kidney Cancer Treatment at Apollo Cancer Centres India</h2>
                        <p className="text-gray-600 text-lg">
                            State-of-the-art kidney cancer treatment infrastructure with world-class facilities, latest technology, expert care, and the best kidney cancer doctor in India - Dr. Vijay Anand Reddy.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 mb-12">
                        <div>
                            <h3 className="text-2xl font-bold text-medical-dark mb-6 flex items-center gap-3">
                                <FaHospital className="text-medical-blue" /> About Apollo Kidney Cancer Center
                            </h3>
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Apollo Cancer Centres is equipped with India's most advanced kidney cancer treatment facilities, offering comprehensive cancer care with the latest diagnostic tools, minimally invasive surgery, precision radiation therapy, targeted treatments, and immunotherapy. Under the leadership of Dr. Vijay Anand Reddy, our center provides world-class <strong>kidney cancer treatment in India</strong>.
                            </p>
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                Our kidney cancer program combines evidence-based medicine with a multidisciplinary team approach, ensuring each patient receives personalized treatment plans tailored to their specific cancer stage, type, and molecular profile.
                            </p>
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20">
                                ...
                                <ul className="space-y-2">
                                    <li className="flex items-start gap-2 text-gray-700 text-sm">
                                        ...
                                        Advanced CT, MRI and molecular imaging
                                    </li>
                                    <li className="flex items-start gap-2 text-gray-700 text-sm">
                                        <span className="w-1.5 h-1.5 bg-medical-blue rounded-full mt-2 flex-shrink-0"></span>
                                        Robotic-assisted partial nephrectomy surgery
                                    </li>
                                    <li className="flex items-start gap-2 text-gray-700 text-sm">
                                        <span className="w-1.5 h-1.5 bg-medical-blue rounded-full mt-2 flex-shrink-0"></span>
                                        Advanced radiation therapy (SBRT) and ablation
                                    </li>
                                    <li className="flex items-start gap-2 text-gray-700 text-sm">
                                        <span className="w-1.5 h-1.5 bg-medical-blue rounded-full mt-2 flex-shrink-0"></span>
                        ...
                        <div className="relative h-full min-h-[400px]">
                            <img
                                ...
                                alt="Apollo Cancer Centre Kidney Cancer Treatment Facility"
                                className="rounded-2xl shadow-xl w-full h-full object-cover"
                            />
                        </div>
                    </div>
                    ...
                    <div className="mt-12">
                        <h3 className="text-2xl font-bold text-medical-dark mb-8 text-center">Advanced Kidney Cancer Treatment Facilities & Equipment</h3>
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    High-resolution CT scans, MRI, PET-CT imaging, and comprehensive biomarker testing for accurate diagnosis and treatment planning.
                                </p>
                            </div>
                            ...
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    Partial and radical nephrectomy, robotic-assisted surgery, and kidney-sparing techniques with faster recovery.
                                </p>
                            </div>
                            ...
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    SBRT (Stereotactic Body Radiation Therapy) with real-time imaging for maximum precision and minimal side effects.
                                </p>
                            </div>
                            ...
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    TKI inhibitors, mTOR inhibitors, and VEGF-targeted therapies for specific kidney cancer subtypes.
                                </p>
                            </div>
                            ...
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    Checkpoint inhibitors (anti-PD1/PDL1) and combination immunotherapy protocols for advanced kidney cancer.
                                </p>
                            </div>
                            ...
                            <div className="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    Counseling, nutrition support, pain management, and survivorship programs for complete well-being.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-14 bg-medical-light">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-gray-600 mb-8 text-lg">
                                As a pioneer in kidney cancer treatment in India, Dr. Vijay Anand Reddy brings world-class expertise in radiation oncology and comprehensive cancer care. His dedication to evidence-based medicine and patient outcomes makes him the preferred choice for kidney cancer treatment.
                            </p>
                            <ul className="space-y-4">
                                {[
                                    "Best kidney cancer treatment doctor in India with 30+ years experience",
                                    "Expertise in advanced radiation therapy (SBRT) and ablation",
                                    "Personalized treatment plans for every patient",
                                    "Multidisciplinary team for comprehensive care",
                                    "Proven track record with 80-90% early detection success",
                                    "Affordable kidney cancer treatment in India"
                                ].map((reason, idx) => (
                    ...
                    <div className="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                            Experience World-Class Kidney Cancer Treatment in India
                        </h3>
                        <p className="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Join thousands of patients who have trusted Dr. Vijay Anand Reddy, the best kidney cancer treatment doctor in India, for advanced cancer treatment with proven results and compassionate care.
                        </p>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <p className="text-gray-600 text-lg">
                            We provide comprehensive support for international patients seeking affordable and high-quality kidney cancer treatment in India.
                        </p>
                    </div>
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                            <div className="text-white max-w-xl">
                                ...
                                <p className="text-blue-100 text-lg mb-6">
                                    Our dedicated International Patient Care team is available 24/7 to assist with treatment planning, cost estimates, and travel arrangements for kidney cancer treatment in India.
                                </p>
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-4xl mx-auto mb-12">
                        ...
                        >
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                                Most Reviewed & Highest Rated <span className="text-medical-blue">Kidney Cancer Treatment Doctor in India</span>
                            </h2>
                            <p className="text-gray-600 text-lg">
                                Dr. Vijay Anand Reddy has earned the trust of thousands of kidney cancer patients through exceptional care, advanced treatment techniques, and outstanding clinical outcomes.
                            </p>
                        </motion.div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                        ...
                        >
                            ...
                            <p className="text-xs text-gray-500 mt-1">For Kidney Cancer Treatment</p>
                        </motion.div>
                    </div>
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-4">
                            Kidney Cancer Patient Video Testimonials
                        </h2>
                        <p className="text-gray-600 text-lg">
                            Hear from our patients about their successful kidney cancer treatment journey with Dr. Vijay Anand Reddy.
                        </p>
                    </div>
            ...
            <section className="py-14">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl md:text-4xl font-bold text-medical-dark mb-8 text-center">Frequently Asked Questions About Kidney Cancer Treatment in India</h2>
                        <p className="text-gray-600 mb-6 text-center">
                            Get answers to common questions about kidney cancer treatment, costs, success rates, and what to expect from India's best kidney cancer treatment doctor, Dr. Vijay Anand Reddy.
                        </p>
...
export default KidneyCancerPage;
