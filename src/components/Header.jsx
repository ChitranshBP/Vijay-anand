...
const Header = () => {
  ...
  },
  {
    ...
    href: '#',
    dropdown: [
      { name: 'Breast Cancer', href: '/conditions/breast-cancer-in-india' },
      { name: 'Lung Cancer', href: '/conditions/lung-cancer-in-india' },
      { name: 'Prostate Cancer', href: '/conditions/prostate-cancer-in-india' },
      { name: 'Cervical Cancer', href: '/conditions/cervical-cancer-in-india' },
      { name: 'Ovarian Cancer', href: '/conditions/ovarian-cancer-in-india' },
      { name: 'Colorectal Cancer', href: '/conditions/colorectal-cancer-in-india' },
      { name: 'Liver Cancer', href: '/conditions/liver-cancer-in-india' },
      { name: 'Kidney Cancer', href: '/conditions/kidney-cancer-in-india' },
      { name: 'Pancreatic Cancer', href: '/conditions/pancreatic-cancer-in-india' },
      { name: 'Thyroid Cancer', href: '/conditions/thyroid-cancer-in-india' },
      { name: 'Eye Cancer', href: '/conditions/eye-cancer-in-india' },
      { name: 'Retinoblastoma', href: '/conditions/retinoblastoma-in-india' },
      { name: 'Uveal Melanoma', href: '/conditions/uveal-melanoma-in-india' },
      { name: 'Eyelid Cancer', href: '/conditions/eyelid-cancer-in-india' },
      { name: 'Brain / CNS Tumors', href: '/conditions/brain-cns-tumors-in-india' },
      { name: 'Bone Cancer / Osteosarcoma', href: '/conditions/bone-cancer-osteosarcoma-in-india' },
      { name: 'Soft Tissue Sarcoma', href: '/conditions/soft-tissue-sarcoma-in-india' },
      { name: 'Pediatric Cancers', href: '/conditions/pediatric-cancers-in-india' },
      { name: 'Oral Cancer', href: '/conditions/oral-cancer-in-india' },
      { name: 'Head & Neck Sub-Conditions', href: '/conditions/head-neck-sub-conditions-in-india' },
    ],
  },
  {
    name: 'Specialties',
    href: '#',
    dropdown: [
      { name: 'Radiation Oncology', href: '/specialty/radiation-oncology-in-india' },
      { name: 'Medical Oncology', href: '/specialty/medical-oncology-in-india' },
      { name: 'Surgical Oncology', href: '/specialty/surgical-oncology-in-india' },
      { name: 'Hemato-Oncology', href: '/specialty/hemato-oncology-in-india' },
      { name: 'Breast Oncology', href: '/specialty/breast-oncology-in-india' },
      { name: 'Head & Neck Oncology', href: '/specialty/head-neck-oncology-in-india' },
      { name: 'Thoracic Oncology', href: '/specialty/thoracic-oncology-in-india' },
      { name: 'Gastrointestinal Oncology', href: '/specialty/gastrointestinal-oncology-in-india' },
      { name: 'Gynecologic Oncology', href: '/specialty/gynecologic-oncology-in-india' },
      { name: 'Uro-Oncology', href: '/specialty/uro-oncology-in-india' },
      { name: 'Ocular Oncology', href: '/specialty/ocular-oncology-in-india' },
      { name: 'Pediatric Oncology', href: '/specialty/pediatric-oncology-in-india' },
      { name: 'Neuro-Oncology', href: '/specialty/neuro-oncology-in-india' },
    ],
  },
  {
    name: 'Treatment',
    href: '#',
    dropdown: [
      { name: 'Chemotherapy', href: '/treatment/chemotherapy-in-india' },
      { name: 'Immunotherapy', href: '/treatment/immunotherapy-in-india' },
      { name: 'Targeted Therapy', href: '/treatment/targeted-therapy-in-india' },
      { name: 'Hormone Therapy', href: '/treatment/hormone-therapy-in-india' },
      { name: 'Biological Therapy', href: '/treatment/biological-therapy-in-india' },
      { name: 'Precision Oncology', href: '/treatment/precision-oncology-in-india' },
      { name: 'External Beam Radiation', href: '/treatment/external-beam-radiation-in-india' },
      { name: 'IMRT', href: '/treatment/imrt-in-india' },
      { name: 'IGRT', href: '/treatment/igrt-in-india' },
      { name: 'SRS', href: '/treatment/srs-in-india' },
      { name: 'SBRT', href: '/treatment/sbrt-in-india' },
      { name: 'Brachytherapy', href: '/treatment/brachytherapy-in-india' },
      { name: 'Tomotherapy', href: '/treatment/tomotherapy-in-india' },
      { name: 'Proton Therapy', href: '/treatment/proton-therapy-in-india' },
      { name: 'Combined Modality Therapy', href: '/treatment/combined-modality-therapy-in-india' },
      { name: 'Supportive Oncology Care', href: '/treatment/supportive-oncology-care-in-india' },
    ],
  },
  {
