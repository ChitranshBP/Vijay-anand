...
<body class="bg-gray-50 text-gray-800 flex flex-col min-h-screen font-sans">
    ...
    $publications = [
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2025/lag time for diagnosis and treatment in 1120.9.pdf"
       ],
       [
            'id' => 2,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2025/A prospective feasibility study on extreme.pdf"
       ],
       [
            'id' => 3,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2009/Ruthenium 106 plaque brachytherapy indications and outcomes in ocular tumors.pdf"
       ],
       [
            'id' => 4,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2005/Neoadjuvant Chemo in the Management of Sebaceous Gland Ca.mht"
       ],
       [
            'id' => 5,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2018/RB in younger versus older children Clinical features and outcom 06-07-2018/retinoblastoma based on age at presentation clinical features and outcome.docx"
       ],
       [
            'id' => 7,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2023/Brachytherapy training in India.pdf"
       ],
       [
            'id' => 8,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2022/A retrospective analysis.pdf"
       ],
       [
            'id' => 9,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2013/Adenoid Cystic ca of the lacrimal gland - SNo. 12.pdf"
       ],
       [
            'id' => 11,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2021/Bevacizumab in Advanced Ovar.pdf"
       ],
       [
            'id' => 12,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2011/Outcome of Retinoblastoma with Vitreous Seeds copy.docx"
       ],
       [
            'id' => 14,
            'title' => "Use of Bevacizumab in Advanced Ovarian Cancer: Consensus from an Expert Panel Oncologists",
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/Publications (Year wise)/2020/IntJNeurooncol 3293.pdf"
       ],
       [
            'id' => 16,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2020/Second primary tumors in retinoblastoma survivors.pdf"
       ],
       [
            'id' => 17,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2020/IJO 2020.pdf"
       ],
       [
            'id' => 18,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2019/Preservation of Retinoblastoma Group E Eyes.pdf"
       ],
       [
            'id' => 20,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2019/Poster - ECR2019_C-1856.pdf"
       ],
       [
            'id' => 21,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2018/Management of RB with Extraocular Tumor Extension.jpg"
       ],
       [
            'id' => 29,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2017/Aqueous Deficient Dry Eye Syndrome Post Orbital Radiotherapy A 10-Year Retrospective Study.pdf"
       ],
       [
            'id' => 32,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2017/Clinical presentation & Outcomes of Stage III or Stage IV RB in 80 Asian Indian Patients.pdf"
       ],
       [
            'id' => 33,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2016/Asian expert recommendation on management of skin.pdf"
       ],
       [
            'id' => 34,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2015/Therapy and Lacrimal Drainage System Toxicity.pdf"
       ],
       [
            'id' => 36,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2013/Gene expression signature of putative Cancer Stem Cells in Retinoblastoma Y79 cell line.pdf"
       ],
       [
            'id' => 41,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/Publications (Year wise)/2013/Evaluation of response to Carboplatin in putative Cancer Stem Cells of Retinoblastoma Y79 cell line.pdf"
       ],
       [
            'id' => 42,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2013/Adenoid Cystic ca of the lacrimal gland - SNo. 12.pdf"
       ],
       [
            'id' => 44,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2013/Primary Intraocular Malignant Extrarenal Rhabdoid tumor.pdf"
       ],
       [
            'id' => 45,
            'title' => "Distant Metastatic Retinoblastoma without Central Nervous System involvement",
            'journal' => "Indian Journal of Ophthalmology April 2013; PubMed ID - 23548316.",
            'pdf' => "../public/assets/Publications (Year wise)/2011/Outcome of Retinoblastoma with Vitreous Seeds copy.docx"
       ],
       [
            'id' => 46,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2012/Orbital Plasmablastic Lymphoma 26-07-2012/Journal of Oncology - Ack. Receipt.doc"
       ],
       [
            'id' => 48,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2011/Evaluation of Human Lacrimal Gland Cultures (IERG).pdf"
       ],
       [
            'id' => 51,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2011/High Dose Rate Interstitial Brachy.pdf"
       ],
       [
            'id' => 52,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2011/Abstracts & Posters - ISRS 2011, Paris/First Indian Experience with Shaped Beam Radiosurgery (POSTER).pdf"
       ],
       [
            'id' => 53,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2011/Abstracts & Posters - ISRS 2011, Paris/Set-up Accuracy with Frameless Radiosurgery (POSTER).pdf"
       ],
       [
            'id' => 54,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2011/Abstracts & Posters - ISRS 2011, Paris/Comparison of Intensity Modulated Stereotactic Radiosurgery (POSTER).pdf"
       ],
       [
            'id' => 55,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2011/Orbital RB - where do we go from here.pdf"
       ],
       [
            'id' => 58,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2010/Cultivation and Characterization of Human Lacrimal Gland.pdf"
       ],
       [
            'id' => 59,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2009/Ruthenium 106 plaque brachytherapy indications and outcomes in ocular tumors.pdf"
       ],
       [
            'id' => 60,
            'title' => "Ruthenium 106 Plaque Brachytherapy : Indications and Outcome in Ocular Tumors",
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2010/Orbital Retinoblastoma.pdf"
       ],
       [
            'id' => 62,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2015/CFS - ISOO Presentations/Orbital Rhabdomyosarcoma- Clinical profile and outcome following multimodal management.pdf"
       ],
       [
            'id' => 63,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2010/Genotype and phenotype correlation analysis in RB.pdf"
       ],
       [
            'id' => 64,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2010/RB1 gene mutations in retinoblastoma and its clinical correlation.pdf"
       ],
       [
            'id' => 65,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2009/Histopathologic risk factors in Retinoblastoma in India.pdf"
       ],
       [
            'id' => 68,
            'title' => "Evisceration in unsuspected Intraocular Tumors",
            'journal' => "Archives of Ophthalmology March 2010; Vol. 128(3); Pg. 372-379.",
            'pdf' => "../public/assets/Publications (Year wise)/2010/Evisceration in unsuspected Intraocular Tumors.pdf"
       ],
       [
            'id' => 69,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2004/Clinicopathologic findings in Choroidal Melanomas.pdf"
       ],
       [
            'id' => 70,
       ...
       [
            ...
            'journal' => "Journal of Cancer Research and Therapeutics 2009; Vol. 5(2) :S97",
            'pdf' => "../public/assets/Publications (Year wise)/2010/Cervical Cancer Screening - Role of Serotyping.pdf"
       ],
       [
            'id' => 73,
            'title' => "Ruthenium 106 Plaque Brachytherapy : Indications and outcome in Ocular Tumors",
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2009/Sebaceous Carcinoma of the Eyelid Metastasizing.mht"
       ],
       [
            'id' => 77,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2009/Periocular Carb Inj in the management of RB with Diffuse Vitreous Seeds - ICOO 2009 Abstracts (Pg. 277).pdf"
       ],
       [
            'id' => 80,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2009/Atlas - Management of Oph. Tumors.pdf"
       ],
       [
            'id' => 82,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2009/Extramedullary Leukemia in Children presenting with Proptosis.pdf"
       ],
       [
            'id' => 84,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2018/Outcome of Multimodal Management of Orbital Rhabdomyosarcoma 06-06-2018.pdf"
       ],
       [
            'id' => 87,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2013/Evaluation of response to Carboplatin in putative Cancer Stem Cells of Retinoblastoma Y79 cell line.pdf"
       ],
       [
            'id' => 88,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2007/Metastasis to the Eye and Orbit from Renal Cell Carcinoma.pdf"
       ],
       [
            'id' => 89,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2007/Systemic Metastasis Following Hyphema Drainage.mht"
       ],
       [
            'id' => 90,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2007/Orbital Embryonal Rhabdomyosarcoma in Association.mht"
       ],
       [
            'id' => 91,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2006/Acute Respiratory Distress Syndrome.pdf"
       ],
       [
            'id' => 92,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2005/Neoadjuvant Chemo in the Management of Sebaceous Gland Ca.mht"
       ],
       [
            'id' => 94,
            ...
            'pdf' => "../public/assets/Publications (Year wise)/1997/Low dose rate Intraluminal Brachytherapy.doc"
       ],
       [
            'id' => 95,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2004/Retinoblastoma in Older Children.pdf"
       ],
       [
            'id' => 98,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2019/Preservation of Retinoblastoma Group E Eyes.pdf"
       ],
       [
            'id' => 101,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2003/Thermochemotherapy in hereditary Retinoblastoma.pdf"
       ],
       [
            'id' => 104,
            'title' => "Retinoblastoma",
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/2001/Ultrasound guided Conformal Brachytherapy in Prostate Ca..pdf"
       ],
       [
            'id' => 108,
       ...
       [
            ...
            'pdf' => "../public/assets/Publications (Year wise)/1992/Assessment of pain in cancer patients (1992).htm"
       ],
       [
            'id' => 113,
