...
$navItems = [
    ...
    [
        ...
        'href' => '#',
        'dropdown' => [
            ['name' => 'Breast Cancer', 'href' => 'conditions.php?type=breast-cancer'],
            ['name' => 'Lung Cancer', 'href' => 'conditions.php?type=lung-cancer'],
            ['name' => 'Prostate Cancer', 'href' => 'conditions.php?type=prostate-cancer'],
            ['name' => 'Cervical Cancer', 'href' => 'conditions.php?type=cervical-cancer'],
            ['name' => 'Ovarian Cancer', 'href' => 'conditions.php?type=ovarian-cancer'],
            ['name' => 'Colorectal Cancer', 'href' => 'conditions.php?type=colorectal-cancer'],
            ['name' => 'Liver Cancer', 'href' => 'conditions.php?type=liver-cancer'],
            ['name' => 'Kidney Cancer', 'href' => 'conditions.php?type=kidney-cancer'],
            ['name' => 'Pancreatic Cancer', 'href' => 'conditions.php?type=pancreatic-cancer'],
            ['name' => 'Thyroid Cancer', 'href' => 'conditions.php?type=thyroid-cancer'],
            ['name' => 'Eye Cancer', 'href' => 'conditions.php?type=eye-cancer'],
            ['name' => 'Retinoblastoma', 'href' => 'conditions.php?type=retinoblastoma'],
            ['name' => 'Uveal Melanoma', 'href' => 'conditions.php?type=uveal-melanoma'],
            ['name' => 'Eyelid Cancer', 'href' => 'conditions.php?type=eyelid-cancer'],
            ['name' => 'Brain / CNS Tumors', 'href' => 'conditions.php?type=brain-cns-tumors'],
            ['name' => 'Bone Cancer / Osteosarcoma', 'href' => 'conditions.php?type=bone-cancer'],
            ['name' => 'Soft Tissue Sarcoma', 'href' => 'conditions.php?type=soft-tissue-sarcoma'],
            ['name' => 'Pediatric Cancers', 'href' => 'conditions.php?type=pediatric-cancers'],
            ['name' => 'Oral Cancer', 'href' => 'conditions.php?type=oral-cancer'],
            ['name' => 'Head & Neck Sub-Conditions', 'href' => 'conditions.php?type=head-neck'],
        ],
    ],
    [
        'name' => 'Specialties',
        'href' => '#',
        'dropdown' => [
            ['name' => 'Radiation Oncology', 'href' => 'specialty.php?type=radiation-oncology'],
            ['name' => 'Medical Oncology', 'href' => 'specialty.php?type=medical-oncology'],
            ['name' => 'Surgical Oncology', 'href' => 'specialty.php?type=surgical-oncology'],
            ['name' => 'Hemato-Oncology', 'href' => 'specialty.php?type=hemato-oncology'],
            ['name' => 'Breast Oncology', 'href' => 'specialty.php?type=breast-oncology'],
            ['name' => 'Head & Neck Oncology', 'href' => 'specialty.php?type=head-neck-oncology'],
            ['name' => 'Thoracic Oncology', 'href' => 'specialty.php?type=thoracic-oncology'],
            ['name' => 'Gastrointestinal Oncology', 'href' => 'specialty.php?type=gastrointestinal-oncology'],
            ['name' => 'Gynecologic Oncology', 'href' => 'specialty.php?type=gynecologic-oncology'],
            ['name' => 'Uro-Oncology', 'href' => 'specialty.php?type=uro-oncology'],
            ['name' => 'Ocular Oncology', 'href' => 'specialty.php?type=ocular-oncology'],
            ['name' => 'Pediatric Oncology', 'href' => 'specialty.php?type=pediatric-oncology'],
            ['name' => 'Neuro-Oncology', 'href' => 'specialty.php?type=neuro-oncology'],
        ],
    ],
    [
        'name' => 'Treatment',
