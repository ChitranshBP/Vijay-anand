...
<head>
    ...
    <title>PrecisionOncologyPage - Dr. Vijay Anand Reddy</title>
    <!-- Google Fonts -->
...
$faqs = [
    [
        'question' => "What is the Precision Oncology in India?",
        'answer' => "Precision Oncology cost in India is significantly more affordable than Western countries, typically ranging from ₹1-5 lakhs per cycle depending on the drug type and cancer stage. The total Precision Oncology in India can vary from ₹5-30 lakhs for a complete treatment course. Dr. Vijay Anand Reddy provides transparent pricing and works with insurance providers to make treatment accessible."
    ],
    [
        'question' => "How effective is precision oncology for cancer treatment?",
        'answer' => "Precision Oncology has shown remarkable success rates, particularly for melanoma, lung cancer, kidney cancer, and lymphoma. Success rates vary by cancer type but can reach 40-60% for certain cancers. Dr. Vijay Anand Reddy uses the latest precision oncology protocols to maximize treatment outcomes."
    ],
    [
        'question' => "What are the side effects of precision oncology?",
        'answer' => "Precision Oncology typically causes fewer side effects than chemotherapy. Common side effects include fatigue, skin reactions, flu-like symptoms, and immune-related inflammation. Dr. Reddy's team provides comprehensive management of side effects with supportive care medicines."
    ],
    [
        'question' => "Which cancers can be treated with precision oncology in India?",
        'answer' => "Precision Oncology is effective for melanoma, non-small cell lung cancer, kidney cancer, bladder cancer, head and neck cancers, Hodgkin lymphoma, and certain types of breast and colon cancer. Dr. Vijay Anand Reddy evaluates each patient's biomarkers to determine precision oncology eligibility."
    ],
    [
        'question' => "How long does precision oncology treatment take?",
        'answer' => "Precision Oncology is typically administered every 2-6 weeks for 6 months to 2 years, depending on cancer type and response. Each infusion takes 30 minutes to a few hours. Dr. Reddy creates personalized treatment schedules based on individual patient needs and cancer characteristics."
    ],
    [
        'question' => "Who is the best precision oncology doctor in India?",
        'answer' => "Dr. Vijay Anand Reddy is recognized as one of the best precision oncology doctors in India, with over 30 years of experience in medical oncology. His expertise in checkpoint inhibitors, CAR-T cell therapy, and personalized precision oncology protocols makes him the preferred choice for cancer precision oncology treatment."
    ],
    [
        'question' => "Can precision oncology cure cancer?",
        'answer' => "Precision Oncology can lead to long-term remission and even cure in some patients, especially with melanoma and certain blood cancers. Response rates vary by cancer type. Dr. Vijay Anand Reddy evaluates each patient's cancer characteristics and biomarkers to determine the likelihood of successful precision oncology response."
    ],
];
?>
<?php
...
$treatmentSteps = [
    ...
    ['step' => "02", 'title' => "Treatment Planning", 'desc' => "Personalized precision oncology protocol.", 'image' => "https://img.freepik.com/free-photo/doctor-analyzing-x-ray-scan_1421-67.jpg"],
...
<?php
$whyChoose = [
    "Best precision oncology doctor in India with 30+ years experience",
    ...
    "Affordable precision oncology treatment costs in India",
];
?>
<?php
$videos = [
...
<div class="min-h-screen bg-white font-sans text-gray-800">
                    ...
                    <div class="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            <span class="inline-block py-1 px-3 rounded-full bg-medical-blue/10 text-medical-blue text-sm font-semibold mb-4">
                                Advanced Cancer Precision Oncology
                            </span>
                            <h1 class="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Best <span class="text-medical-blue">Precision Oncology Cost</span> in India
                            </h1>
                            <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                                Seeking affordable <strong>Precision Oncology in India</strong>? Dr. Vijay Anand Reddy offers cutting-edge precision oncology treatment with the latest genomic profiling and targeted treatments at Apollo Cancer Centres Hyderabad. Get world-class cancer care at 60-70% lower cost than Western countries.
                            </p>
    ...
    <?php endforeach; ?>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Advanced Precision Oncology Cancer Treatment in India</h2>
                        <p class="text-gray-600 text-lg">
                            Experience cutting-edge precision oncology with the latest checkpoint inhibitors, CAR-T cell therapy, and personalized protocols. Dr. Vijay Anand Reddy offers the best Precision Oncology in India with proven outcomes.
                        </p>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <p class="text-gray-600 mb-6 leading-relaxed">
                                Precision Oncology harnesses your body's genetic mutations to personalize treatment. Dr. Vijay Anand Reddy, a leading <strong>precision oncology specialist in India</strong>, offers advanced checkpoint inhibitors (anti-PD-1, anti-PD-L1, anti-CTLA-4), CAR-T cell therapy, and cancer vaccines tailored to each patient's unique cancer type and biomarker profile.
                            </p>
                        ...
                        <div class="relative h-full min-h-[400px]">
                            <img
                                ...
                                alt="Precision Oncology Treatment in India"
                    ...
                    <div class="mt-12 bg-medical-light p-8 rounded-2xl border border-medical-blue/20">
                        <h3 class="text-2xl font-bold text-medical-dark mb-6 text-center">Precision Oncology Cost in India - Transparent Pricing</h3>
                        ...
                        <p class="text-center text-gray-600 mt-6">
                            <strong>Note:</strong> Exact Precision Oncology in India depends on cancer type, drug selection, biomarker status, and treatment duration. Contact us for personalized cost estimate.
                        </p>
                    </div>
                    ...
                    <div class="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        <h3 class="text-2xl md:text-3xl font-bold text-white mb-4">
                            Schedule Your Precision Oncology Consultation with Dr. Vijay Anand Reddy
                        </h3>
                        <p class="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Get expert guidance on advanced precision oncology treatment in India. Book a personalized consultation to discuss your cancer treatment options and customized care plan.
                        </p>
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                                <img
                                    ...
                                    alt="Dr. Vijay Anand Reddy - Best Precision Oncology Doctor in India"
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished oncologist with over 30 years of experience in providing world-class cancer care. As the Director of Apollo Cancer Centres, Hyderabad, he has pioneered advanced precision oncology protocols and personalized cancer treatment approaches in India.
                            </p>
                            <p class="text-gray-600 mb-8 leading-relaxed">
                                He is renowned for his expertise in precision oncology, checkpoint inhibitors, and CAR-T cell therapy. His commitment to personalized patient care, use of latest precision oncology drugs, and evidence-based medicine has earned him recognition as one of India's leading precision oncology specialists.
                            </p>
            ...
            <!-- Quote Section -->
            <?php $quoteId = 31; include 'quote_section.php'; ?>

            <!-- Treatment Process -->
            <section class="py-14 bg-medical-light">
                <div class="container mx-auto px-4">
                    <div class="text-center mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Our Precision Oncology Treatment Process</h2>
                        <p class="text-gray-600 text-lg max-w-3xl mx-auto">
                            A systematic, patient-centric approach to precision oncology treatment. Dr. Vijay Anand Reddy and his team follow a comprehensive 4-step process for optimal cancer treatment outcomes.
                        </p>
                    </div>
    ...
    <?php endforeach; ?>
                    ...
                    <div class="mt-12 text-center">
                        <div class="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-medical-blue max-w-4xl mx-auto">
                            <h3 class="text-2xl md:text-3xl font-bold text-medical-dark mb-4">
                                Begin Your Precision Oncology Treatment Journey Today
                            </h3>
                            <p class="text-gray-600 mb-6 text-lg">
                                Don't wait to start your journey to recovery. Dr. Vijay Anand Reddy and our expert team are ready to provide you with the best precision oncology cancer treatment in India with world-class care.
                            </p>
                            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                <a href="#book-appointment" class="px-8 py-4 bg-medical-blue text-white rounded-lg font-semibold hover:bg-medical-dark transition shadow-lg flex items-center justify-center gap-2">
            ...
            <!-- Apollo Hospital Precision Oncology Section -->
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Precision Oncology at Apollo Cancer Centres India</h2>
                        <p class="text-gray-600 text-lg">
                            State-of-the-art precision oncology infrastructure with world-class facilities, latest drugs, expert care, and the best precision oncology doctor in India - Dr. Vijay Anand Reddy.
                        </p>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-12 mb-12">
                        <div>
                            <h3 class="text-2xl font-bold text-medical-dark mb-6 flex items-center gap-3">
                                <i class="far fa-hospital"></i> About Apollo Precision Oncology Center
                            </h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">
                                Apollo Cancer Centres is equipped with India's most advanced precision oncology facilities, offering comprehensive cancer treatment with the latest checkpoint inhibitors, CAR-T cell therapy, and cancer vaccines. Under the leadership of Dr. Vijay Anand Reddy, our center provides world-class precision oncology care.
                            </p>
                            <p class="text-gray-600 mb-6 leading-relaxed">
                                Our precision oncology program combines evidence-based medicine with a multidisciplinary team approach, ensuring each patient receives personalized treatment plans tailored to their specific biomarker profile and cancer type.
                            </p>
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start gap-2 text-gray-700 text-sm">
                                        ...
                                        Latest precision oncology drugs (Pembrolizumab, Nivolumab, Atezolizumab)
                                    </li>
                                    <li class="flex items-start gap-2 text-gray-700 text-sm">
                                        <span class="w-1.5 h-1.5 bg-medical-blue rounded-full mt-2 flex-shrink-0"></span>
                        ...
                        <div class="relative h-full min-h-[400px]">
                            <img
                                ...
                                alt="Apollo Cancer Centre Precision Oncology Facility"
                                class="rounded-2xl shadow-xl w-full h-full object-cover"
                            />
                        </div>
                    </div>
                    ...
                    <div class="mt-12">
                        <h3 class="text-2xl font-bold text-medical-dark mb-8 text-center">Advanced Precision Oncology Facilities & Equipment</h3>
                        <div class="grid md:grid-cols-3 gap-6">
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <h4 class="font-bold text-medical-dark mb-3">Latest Precision Oncology Drugs</h4>
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Dedicated precision oncology infusion centers with comfortable recliners, trained nurses, and strict safety protocols for drug administration.
                                </p>
                            </div>
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Real-time monitoring during precision oncology infusions with immediate intervention capabilities for any immune-related reactions.
                                </p>
                            </div>
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Next-generation sequencing and liquid biopsy facilities to identify optimal precision oncology candidates and monitor treatment response.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                    Every precision oncology plan is based on comprehensive biomarker testing including PD-L1 expression, TMB, MSI status, and tumor-infiltrating lymphocytes to identify best responders.
                                </p>
                            </div>
                            <div>
                                <h4 class="font-bold text-medical-dark mb-4 flex items-center gap-2">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                    Our tumor board includes medical oncologists, immunologists, pathologists, radiologists, and support staff who collaborate for comprehensive precision oncology care.
                                </p>
                            </div>
                            <div>
                                <h4 class="font-bold text-medical-dark mb-4 flex items-center gap-2">
                    ...
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2">
                            ...
                            <p class="text-gray-600 mb-8 text-lg">
                                As a pioneer in precision oncology in India, Dr. Vijay Anand Reddy brings world-class expertise in genomic profiling and targeted treatments. His dedication to evidence-based medicine and patient outcomes makes him the preferred choice for precision oncology treatment.
                            </p>
                            <ul class="space-y-4">
    ...
    <?php endforeach; ?>
                    ...
                    <div class="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        <h3 class="text-2xl md:text-3xl font-bold text-white mb-4">
                            Experience World-Class Precision Oncology Treatment in India
                        </h3>
                        <p class="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Join thousands of patients who have trusted Dr. Vijay Anand Reddy, the best precision oncology doctor in India, for advanced cancer treatment with proven results and compassionate care.
                        </p>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <p class="text-gray-600 text-lg">
                            We provide comprehensive support for international patients seeking affordable and high-quality precision oncology treatment in India.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Initial video consultation to discuss precision oncology options before travel."
                            },
                            {
                        ...
                        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                            <div class="text-white max-w-xl">
                                ...
                                <p class="text-blue-100 text-lg mb-6">
                                    Our dedicated International Patient Care team is available 24/7 to assist with treatment planning, cost estimates, and travel arrangements for precision oncology in India.
                                </p>
                ...
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-4xl mx-auto mb-12">
                        ...
                        >
                            ...
                            <h2 class="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                                Most Reviewed & Highest Rated <span class="text-medical-blue">Precision Oncology Doctor in India</span>
                            </h2>
                            <p class="text-gray-600 text-lg">
                                Dr. Vijay Anand Reddy has earned the trust of thousands of cancer patients through exceptional care, advanced precision oncology treatments, and outstanding clinical outcomes.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                        ...
                        >
                            ...
                            <p class="text-xs text-gray-500 mt-1">For Precision Oncology</p>
                        </div>
                    </div>
