...
<head>
    ...
    <title>EyeCancerPage - Dr. Vijay Anand Reddy</title>
    <!-- Google Fonts -->
...
<div class="min-h-screen bg-white font-sans text-gray-800">
                    ...
                    <div class="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            ...
                            <h1 class="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Best <span class="text-medical-blue">Eye Cancer Treatment</span> in India
                            </h1>
    ...
    <?php endfor; ?>
                            ...
                            >
                                ...
                                <p class="text-gray-600 text-sm font-medium">Eye Cancer Doctor in India</p>
                            </div>
    ...
    <?php endforeach; ?>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Comprehensive Eye Cancer Treatment in India</h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-12 items-start">
                        ...
                        <div class="relative h-full min-h-[400px]">
                            <img
                                src="/public/assets/condiotion-images/eye-cancer.webp"
            ...
            <!-- Quote Section -->
            <?php $quoteId = 6; include 'quote_section.php'; ?>

            <!-- Treatment Process -->
            <section class="py-14 bg-medical-light">
                <div class="container mx-auto px-4">
                    <div class="text-center mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Our Eye Cancer Treatment Process</h2>
    ...
    <?php endforeach; ?>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Eye Cancer Treatment at Apollo Cancer Centres India</h2>
                        <p class="text-gray-600 text-lg">
                    ...
                    <div class="grid md:grid-cols-2 gap-12 mb-12">
                        <div>
                            <h3 class="text-2xl font-bold text-medical-dark mb-6 flex items-center gap-3">
                                <i class="far fa-hospital"></i> About Apollo Eye Cancer Center
                            </h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">
                    ...
                    <div class="mt-12">
                        <h3 class="text-2xl font-bold text-medical-dark mb-8 text-center">Advanced Eye Cancer Treatment Facilities & Equipment</h3>
