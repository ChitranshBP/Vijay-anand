...
<head>
    ...
    <title>HematoOncologyPage - Dr. Vijay Anand Reddy</title>
    <!-- Google Fonts -->
...
<div class="min-h-screen bg-white font-sans text-gray-800">
                    ...
                    <div class="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            ...
                            <h1 class="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Leading <span class="text-medical-blue">Hemato-Oncology</span> in India
                            </h1>
    ...
    <?php endfor; ?>
                            ...
                            >
                                ...
                                <p class="text-gray-600 text-sm font-medium">Hemato-Oncology Expert</p>
                            </div>
    ...
    <?php endforeach; ?>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">World-Class Hemato-Oncology in India</h2>
            ...
            <?php $quoteId = 43; include 'quote_section.php'; ?>
    ...
    <?php endforeach; ?>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Advanced Hemato-Oncology at Apollo Cancer Centres India</h2>
                        <p class="text-gray-600 text-lg">
                    ...
                    <div class="text-center max-w-4xl mx-auto mb-12">
                        ...
                        >
                            ...
                            <h2 class="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                                Most Reviewed & Highest Rated <span class="text-medical-blue">Hemato-Oncologist in India</span>
                            </h2>
                            <p class="text-gray-600 text-lg">
