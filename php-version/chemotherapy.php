...
<head>
    ...
    <title>ChemotherapyPage - Dr. Vijay Anand Reddy</title>
    <!-- Google Fonts -->
...
$faqs = [
    [
        'question' => "Who is the best chemotherapy doctor in India?",
        'answer' => "Dr. Vijay Anand Reddy is widely recognized as one of the best chemotherapy doctors in India, with over 30 years of experience in medical oncology. His expertise in advanced chemotherapy protocols, personalized treatment plans, and compassionate patient care makes him the preferred choice for cancer patients across India and internationally."
    ],
    [
        'question' => "What types of cancer can be treated with chemotherapy in India?",
        'answer' => "Chemotherapy treatment in India is effective for various cancers including breast cancer, lung cancer, colorectal cancer, lymphoma, leukemia, ovarian cancer, prostate cancer, pancreatic cancer, and many others. Dr. Vijay Anand Reddy customizes chemotherapy protocols based on cancer type, stage, and individual patient factors."
    ],
    [
        'question' => "What are the side effects of chemotherapy treatment?",
        'answer' => "Common side effects include fatigue, nausea, hair loss, reduced immunity, and anemia. However, modern chemotherapy protocols and supportive care medicines significantly reduce these effects. Dr. Reddy's team provides comprehensive side effect management, including anti-nausea medications, growth factors, and nutritional support to ensure patient comfort throughout treatment."
    ],
    [
        'question' => "How long does chemotherapy treatment take in India?",
        'answer' => "Chemotherapy duration varies based on cancer type and stage. Most treatments involve multiple cycles over 3-6 months, with each cycle lasting 1-3 weeks. Some cancers may require longer treatment. Dr. Vijay Anand Reddy creates personalized treatment schedules that balance effectiveness with quality of life considerations."
    ],
    [
        'question' => "What is the cost of chemotherapy treatment in India?",
        'answer' => "Chemotherapy treatment in India is significantly more affordable than in Western countries, offering 60-80% cost savings without compromising quality. The exact cost depends on cancer type, chemotherapy drugs used, number of cycles, and hospital facilities. Dr. Reddy's clinic offers transparent pricing and treatment packages. Contact us for personalized cost estimates."
    ],
    [
        'question' => "How effective is chemotherapy treatment in India?",
        'answer' => "Chemotherapy treatment in India achieves success rates comparable to top international centers. Apollo Cancer Centres, where Dr. Vijay Anand Reddy practices, uses internationally approved chemotherapy protocols and the latest drugs. Success rates vary by cancer type and stage, with early-stage cancers showing excellent outcomes."
    ],
    [
        'question' => "Can I combine chemotherapy with other cancer treatments?",
        'answer' => "Yes, chemotherapy is often combined with surgery, radiation therapy, immunotherapy, or targeted therapy for optimal outcomes. This multimodal approach is called combined modality therapy. Dr. Vijay Anand Reddy's multidisciplinary team develops comprehensive treatment plans that may include multiple treatment types based on your specific cancer."
    ],
];
?>
<?php
...
<?php
$treatmentSteps = [
    ['step' => "01", 'title' => "Consultation & Evaluation", 'desc' => "Comprehensive assessment and treatment planning.", 'image' => "https://img.freepik.com/free-photo/doctor-patient-discussing-medical-report_1421-66.jpg"],
    ['step' => "02", 'title' => "Treatment Planning", 'desc' => "Personalized chemotherapy protocol development.", 'image' => "https://img.freepik.com/free-photo/doctor-analyzing-x-ray-scan_1421-67.jpg"],
    ['step' => "03", 'title' => "Chemotherapy Administration", 'desc' => "Safe drug delivery with monitoring.", 'image' => "https://img.freepik.com/free-photo/medical-team-meeting_1421-68.jpg"],
    ['step' => "04", 'title' => "Follow-up & Support", 'desc' => "Regular monitoring and supportive care.", 'image' => "https://img.freepik.com/free-photo/surgeons-operating-room_1421-69.jpg"],
];
?>
<?php
$whyChoose = [
    "Best chemotherapy doctor in India with 30+ years experience",
    "Expertise in latest chemotherapy protocols and drugs",
    "Access to cutting-edge cancer treatment technologies",
    "Multidisciplinary team for comprehensive care",
    "Proven track record with high success rates",
    "Affordable chemotherapy treatment costs in India",
];
?>
<?php
$videos = [
...
<div class="min-h-screen bg-white font-sans text-gray-800">
            ...
            <section class="relative pt-28 pb-16 lg:pt-40 lg:pb-24 overflow-hidden">
                <!-- Background Image with Light Color Overlay -->
                    ...
                    <div class="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            <span class="inline-block py-1 px-3 rounded-full bg-medical-blue/10 text-medical-blue text-sm font-semibold mb-4">
                                Advanced Medical Oncology in India
                            </span>
                            <h1 class="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Best <span class="text-medical-blue">Chemotherapy Treatment</span> in India
                            </h1>
                            <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                                Seeking world-class <strong>chemotherapy treatment in India</strong>? Dr. Vijay Anand Reddy offers advanced chemotherapy protocols, personalized care plans, and comprehensive oncology support at Apollo Cancer Centres Hyderabad with 30+ years of expertise.
                            </p>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-8">
                                <div class="bg-white p-4 rounded-lg border border-medical-blue/20 shadow-sm">
                                    ...
                                    <p class="text-xs text-gray-600">Treatment Success Rate</p>
                                </div>
                                <div class="bg-white p-4 rounded-lg border border-medical-blue/20 shadow-sm">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                <a href="#book-appointment" class="px-8 py-4 bg-medical-blue text-white rounded-lg font-semibold hover:bg-medical-dark transition shadow-lg flex items-center justify-center gap-2" aria-label="Book Chemotherapy Appointment">
                                    <i class="far fa-calendar-alt"></i> Book Appointment
                                </a>
                                <a href="tel:+919676720002" class="px-8 py-4 bg-white text-medical-blue border border-medical-blue/30 rounded-lg font-semibold hover:bg-medical-light transition shadow-sm flex items-center justify-center gap-2" aria-label="Call for Chemotherapy">
    ...
    <?php endforeach; ?>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Advanced Chemotherapy Cancer Treatment in India</h2>
                        <p class="text-gray-600 text-lg">
                            Experience cutting-edge chemotherapy treatment with the latest drugs, personalized protocols, and comprehensive supportive care. Dr. Vijay Anand Reddy offers the best chemotherapy treatment in India with proven outcomes.
                        </p>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-12 items-start">
                        <div>
                            <h3 class="text-2xl font-bold text-medical-dark mb-6 flex items-center gap-3">
                                <i class="fas fa-pills"></i> Overview
                            </h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">
                                Chemotherapy is a systemic cancer treatment that uses powerful drugs to destroy cancer cells throughout the body. Dr. Vijay Anand Reddy, a leading <strong>chemotherapy specialist in India</strong>, offers advanced chemotherapy protocols including targeted chemotherapy, dose-dense regimens, and combination therapy tailored to each patient's unique cancer type and stage.
                            </p>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    <div class="bg-medical-blue/10 p-3 rounded-lg text-medical-blue mt-1"><FaSyringe size={24} /></div>
                                    <div>
                                        <h4 class="font-bold text-medical-dark">Systemic Treatment</h4>
                                        <p class="text-sm text-gray-500">Targets cancer throughout body.</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    <div class="bg-medical-blue/10 p-3 rounded-lg text-medical-blue mt-1"><i class="fas fa-dna"></i></div>
                                    <div>
                                        <h4 class="font-bold text-medical-dark">Targeted Drugs</h4>
                                        <p class="text-sm text-gray-500">Precision chemotherapy agents.</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    <div class="bg-medical-blue/10 p-3 rounded-lg text-medical-blue mt-1"><i class="fas fa-users"></i></div>
                                    <div>
                                        <h4 class="font-bold text-medical-dark">All Cancer Types</h4>
                                        <p class="text-sm text-gray-500">Effective for multiple cancers.</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    <div class="bg-medical-blue/10 p-3 rounded-lg text-medical-blue mt-1"><i class="fas fa-shield-alt"></i></div>
                                    <div>
                                        <h4 class="font-bold text-medical-dark">Side Effect Control</h4>
                                        <p class="text-sm text-gray-500">Advanced supportive care.</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    <div class="bg-medical-blue/10 p-3 rounded-lg text-medical-blue mt-1"><FaHeartbeat size={24} /></div>
                                    <div>
                                        <h4 class="font-bold text-medical-dark">Improved Outcomes</h4>
                                        <p class="text-sm text-gray-500">High remission rates.</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    <div class="bg-medical-blue/10 p-3 rounded-lg text-medical-blue mt-1"><i class="fas fa-chart-line"></i></div>
                                    <div>
                                        <h4 class="font-bold text-medical-dark">Quality of Life</h4>
                                        <p class="text-sm text-gray-500">Maintained during treatment.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative h-full min-h-[400px]">
                            <img
                                src="/public/assets/treatments/chemotherapy.webp"
                    ...
                    <div class="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        <h3 class="text-2xl md:text-3xl font-bold text-white mb-4">
                            Schedule Your Chemotherapy Consultation with Dr. Vijay Anand Reddy
                        </h3>
                        <p class="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Get expert guidance on advanced chemotherapy treatment in India. Book a personalized consultation to discuss your cancer treatment options and customized care plan.
                        </p>
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="#book-appointment" class="px-8 py-4 bg-white text-medical-blue rounded-lg font-semibold hover:bg-gray-100 transition shadow-lg flex items-center justify-center gap-2" aria-label="Book Chemotherapy Consultation">
                                <i class="far fa-calendar-alt"></i> Book Consultation Now
                            </a>
                            <a href="tel:+919676720002" class="px-8 py-4 bg-medical-dark text-white border-2 border-white rounded-lg font-semibold hover:bg-medical-purple transition flex items-center justify-center gap-2" aria-label="Call for Chemotherapy Information">
                                <i class="fas fa-phone-alt"></i> Call +91-9676720002
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                                <img
                                    ...
                                    alt="Dr. Vijay Anand Reddy - Best Chemotherapy Doctor in India"
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished oncologist with over 30 years of experience in providing world-class cancer care. As the Director of Apollo Cancer Centres, Hyderabad, he has pioneered advanced chemotherapy protocols and multimodal cancer treatment approaches in India.
                            </p>
                            <p class="text-gray-600 mb-8 leading-relaxed">
                                He is renowned for his expertise in chemotherapy treatment and has successfully treated thousands of patients with various cancers. His commitment to personalized patient care, use of latest chemotherapy drugs, and evidence-based medicine has earned him recognition as one of India's leading oncologists.
                            </p>
            ...
            <!-- Quote Section -->
            <?php $quoteId = 24; include 'quote_section.php'; ?>

            <!-- Treatment Process -->
            <section class="py-14 bg-medical-light">
                <div class="container mx-auto px-4">
                    <div class="text-center mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Our Chemotherapy Treatment Process</h2>
                        <p class="text-gray-600 text-lg max-w-3xl mx-auto">
                            A systematic, patient-centric approach to chemotherapy treatment. Dr. Vijay Anand Reddy and his team follow a comprehensive 4-step process for optimal cancer treatment outcomes.
                        </p>
                    </div>
    ...
    <?php endforeach; ?>
                    ...
                    <div class="mt-12 text-center">
                        <div class="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-medical-blue max-w-4xl mx-auto">
                            <h3 class="text-2xl md:text-3xl font-bold text-medical-dark mb-4">
                                Begin Your Chemotherapy Treatment Journey Today
                            </h3>
                            <p class="text-gray-600 mb-6 text-lg">
                                Don't wait to start your journey to recovery. Dr. Vijay Anand Reddy and our expert team are ready to provide you with the best chemotherapy cancer treatment in India with world-class care.
                            </p>
                            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                <a href="#book-appointment" class="px-8 py-4 bg-medical-blue text-white rounded-lg font-semibold hover:bg-medical-dark transition shadow-lg flex items-center justify-center gap-2" aria-label="Schedule Chemotherapy Appointment">
                                    <i class="far fa-calendar-alt"></i> Schedule Appointment
                                </a>
                                <a href="tel:+919676720002" class="px-8 py-4 bg-white text-medical-blue border-2 border-medical-blue rounded-lg font-semibold hover:bg-medical-light transition flex items-center justify-center gap-2" aria-label="Call for Chemotherapy Consultation">
                                    <i class="fas fa-phone-alt"></i> Call +91-9676720002
                                </a>
                            </div>
                        </div>
            ...
            <!-- Apollo Hospital Chemotherapy Section -->
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Chemotherapy at Apollo Cancer Centres India</h2>
                        <p class="text-gray-600 text-lg">
                            State-of-the-art chemotherapy infrastructure with world-class facilities, latest drugs, expert care, and the best chemotherapy doctor in India - Dr. Vijay Anand Reddy. Experience advanced cancer treatment with comprehensive support.
                        </p>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-12 mb-12">
                        <div>
                            <h3 class="text-2xl font-bold text-medical-dark mb-6 flex items-center gap-3">
                                <i class="far fa-hospital"></i> About Apollo Chemotherapy Center
                            </h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">
                                Apollo Cancer Centres is equipped with India's most advanced chemotherapy facilities, offering comprehensive cancer treatment with the latest chemotherapy drugs and protocols. Under the leadership of Dr. Vijay Anand Reddy, our center provides world-class cancer care with cutting-edge infrastructure.
                            </p>
                            <p class="text-gray-600 mb-6 leading-relaxed">
                                Our chemotherapy program combines evidence-based medicine with a multidisciplinary team approach, ensuring each patient receives personalized treatment plans tailored to their specific cancer type and stage.
                            </p>
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start gap-2 text-gray-700 text-sm">
                                        ...
                                        Latest chemotherapy drugs and protocols
                                    </li>
                                    <li class="flex items-start gap-2 text-gray-700 text-sm">
                                        <span class="w-1.5 h-1.5 bg-medical-blue rounded-full mt-2 flex-shrink-0"></span>
                                    ...
                                    <li class="flex items-start gap-2 text-gray-700 text-sm">
                                        <span class="w-1.5 h-1.5 bg-medical-blue rounded-full mt-2 flex-shrink-0"></span>
                                        Comprehensive supportive care program
                                    </li>
                                    <li class="flex items-start gap-2 text-gray-700 text-sm">
                                        <span class="w-1.5 h-1.5 bg-medical-blue rounded-full mt-2 flex-shrink-0"></span>
                                        24/7 emergency care and monitoring
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="relative h-full min-h-[400px]">
                            <img
                                ...
                                alt="Apollo Cancer Centre Chemotherapy Facility"
                                class="rounded-2xl shadow-xl w-full h-full object-cover"
                            />
                        </div>
                    </div>
                    ...
                    <div class="mt-12">
                        <h3 class="text-2xl font-bold text-medical-dark mb-8 text-center">Advanced Chemotherapy Facilities & Equipment</h3>
                        <div class="grid md:grid-cols-3 gap-6">
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <h4 class="font-bold text-medical-dark mb-3">Latest Chemotherapy Drugs</h4>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Access to newest chemotherapy agents including targeted therapy drugs, immunotherapy, and precision oncology medications approved internationally.
                                </p>
                            </div>

                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                <div class="bg-medical-blue/10 w-14 h-14 rounded-lg flex items-center justify-center mb-4">
                                    <FaSyringe class="text-medical-blue text-2xl" />
                                </div>
                                <h4 class="font-bold text-medical-dark mb-3">Safe Infusion Centers</h4>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Modern chemotherapy day care centers with comfortable recliners, trained nurses, and strict safety protocols for drug administration.
                                </p>
                            </div>
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Comprehensive laboratory services for treatment monitoring, biomarker testing, and personalized medicine approaches.
                                </p>
                            </div>

                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                <div class="bg-medical-blue/10 w-14 h-14 rounded-lg flex items-center justify-center mb-4">
                                    <FaNotesMedical class="text-medical-blue text-2xl" />
                                </div>
                                <h4 class="font-bold text-medical-dark mb-3">Supportive Care Services</h4>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Complete supportive care including anti-nausea medications, growth factors, pain management, and nutritional counseling.
                                </p>
                            </div>

                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                <div class="bg-medical-blue/10 w-14 h-14 rounded-lg flex items-center justify-center mb-4">
                                    <FaHeartbeat class="text-medical-blue text-2xl" />
                                </div>
                                <h4 class="font-bold text-medical-dark mb-3">Patient Monitoring Systems</h4>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Real-time vital signs monitoring during chemotherapy administration ensuring patient safety and immediate intervention if needed.
                                </p>
                            </div>
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <h4 class="font-bold text-medical-dark mb-3">Precision Medicine Lab</h4>
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Molecular testing and genetic profiling facilities to identify optimal chemotherapy agents for individual tumors.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Treatment Approach -->
                    <div class="mt-12 bg-medical-light p-8 rounded-2xl border border-medical-blue/20">
                        <h3 class="text-2xl font-bold text-medical-dark mb-6 text-center">Our Comprehensive Treatment Approach</h3>
                        <div class="grid md:grid-cols-2 gap-8">
                            <div>
                                <h4 class="font-bold text-medical-dark mb-4 flex items-center gap-2">
                                    <i class="fas fa-bullseye"></i> Personalized Protocols
                                </h4>
                                <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                    Every chemotherapy plan is customized based on cancer type, stage, molecular profile, and patient-specific factors. We use the latest evidence-based protocols for optimal outcomes.
                                </p>
                            </div>
                            <div>
                                <h4 class="font-bold text-medical-dark mb-4 flex items-center gap-2">
                                    <i class="fas fa-users"></i> Multidisciplinary Team
                                </h4>
                                <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                    Our tumor board includes medical oncologists, radiation oncologists, surgeons, pathologists, and support staff who collaborate for comprehensive care.
                                </p>
                            </div>
                            <div>
                                <h4 class="font-bold text-medical-dark mb-4 flex items-center gap-2">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                    Strict protocols for drug handling, administration, and monitoring ensure maximum safety. All staff are trained in chemotherapy safety guidelines.
                                </p>
                            </div>
                            <div>
                                <h4 class="font-bold text-medical-dark mb-4 flex items-center gap-2">
                                    <i class="fas fa-heart"></i> Holistic Support
                                </h4>
                                <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                    Beyond medical treatment, we provide counseling, nutrition support, pain management, and rehabilitation services for complete patient well-being.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2">
                            ...
                            <p class="text-gray-600 mb-8 text-lg">
                                As a pioneer in medical oncology in India, Dr. Vijay Anand Reddy brings world-class expertise in chemotherapy treatment. His dedication to evidence-based medicine and patient outcomes makes him the preferred choice for cancer treatment.
                            </p>
                            <ul class="space-y-4">
    ...
    <?php endforeach; ?>
                    ...
                    <div class="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        <h3 class="text-2xl md:text-3xl font-bold text-white mb-4">
                            Experience World-Class Chemotherapy Treatment in India
                        </h3>
                        <p class="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Join thousands of patients who have trusted Dr. Vijay Anand Reddy, the best chemotherapy doctor in India, for advanced cancer treatment with proven results and compassionate care.
                        </p>
                        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <a href="#book-appointment" class="px-8 py-4 bg-white text-medical-blue rounded-lg font-bold hover:bg-gray-100 transition shadow-lg flex items-center justify-center gap-2 text-lg" aria-label="Book Chemotherapy Consultation">
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <p class="text-gray-600 text-lg">
                            We provide comprehensive support for international patients seeking affordable and high-quality chemotherapy treatment in India.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Initial video consultation to discuss chemotherapy options before travel."
                            },
                            {
                        ...
                        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                            <div class="text-white max-w-xl">
                                ...
                                <p class="text-blue-100 text-lg mb-6">
                                    Our dedicated International Patient Care team is available 24/7 to assist with treatment planning, cost estimates, and travel arrangements for chemotherapy in India.
                                </p>
                ...
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-4xl mx-auto mb-12">
                        ...
                        >
                            ...
                            <h2 class="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                                Most Reviewed & Highest Rated <span class="text-medical-blue">Chemotherapy Doctor in India</span>
                            </h2>
                            <p class="text-gray-600 text-lg">
                                Dr. Vijay Anand Reddy has earned the trust of thousands of cancer patients through exceptional care, advanced chemotherapy treatments, and outstanding clinical outcomes. As the best chemotherapy doctor in India, he consistently delivers world-class medical oncology care.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                        ...
                        >
                            ...
                            <p class="text-xs text-gray-500 mt-1">For Chemotherapy</p>
                        </div>
                    </div>
