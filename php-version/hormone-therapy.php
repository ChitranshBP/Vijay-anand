...
<head>
    ...
    <title>HormoneTherapyPage - Dr. Vijay Anand Reddy</title>
    <!-- Google Fonts -->
...
$faqs = [
    [
        ...
        'answer' => "Hormone Therapy cost in India is significantly more affordable than Western countries, typically ranging from ₹1-5 lakhs per cycle depending on the drug type and cancer stage. The total Hormone Therapy cost in India can vary from ₹5-30 lakhs for a complete treatment course. Dr. Vijay Anand Reddy provides transparent pricing and works with insurance providers to make treatment accessible."
    ],
    [
        'question' => "How effective is hormone therapy for cancer treatment?",
        'answer' => "Hormone Therapy has shown remarkable success rates, particularly for melanoma, lung cancer, kidney cancer, and lymphoma. Success rates vary by cancer type but can reach 40-60% for certain cancers. Dr. Vijay Anand Reddy uses the latest hormone therapy protocols to maximize treatment outcomes."
    ],
    [
        'question' => "What are the side effects of hormone therapy?",
        'answer' => "Hormone Therapy typically causes fewer side effects than chemotherapy. Common side effects include fatigue, skin reactions, flu-like symptoms, and immune-related inflammation. Dr. Reddy's team provides comprehensive management of side effects with supportive care medicines."
    ],
    [
        'question' => "Which cancers can be treated with hormone therapy in India?",
        'answer' => "Hormone Therapy is effective for melanoma, non-small cell lung cancer, kidney cancer, bladder cancer, head and neck cancers, Hodgkin lymphoma, and certain types of breast and colon cancer. Dr. Vijay Anand Reddy evaluates each patient's biomarkers to determine hormone therapy eligibility."
    ],
    [
        'question' => "How long does hormone therapy treatment take?",
        'answer' => "Hormone Therapy is typically administered every 2-6 weeks for 6 months to 2 years, depending on cancer type and response. Each infusion takes 30 minutes to a few hours. Dr. Reddy creates personalized treatment schedules based on individual patient needs and cancer characteristics."
    ],
    [
        'question' => "Who is the best hormone therapy doctor in India?",
        'answer' => "Dr. Vijay Anand Reddy is recognized as one of the best hormone therapy doctors in India, with over 30 years of experience in medical oncology. His expertise in checkpoint inhibitors, CAR-T cell therapy, and personalized hormone therapy protocols makes him the preferred choice for cancer hormone therapy treatment."
    ],
    [
        'question' => "Can hormone therapy cure cancer?",
        'answer' => "Hormone Therapy can lead to long-term remission and even cure in some patients, especially with melanoma and certain blood cancers. Response rates vary by cancer type. Dr. Vijay Anand Reddy evaluates each patient's cancer characteristics and biomarkers to determine the likelihood of successful hormone therapy response."
    ],
];
?>
<?php
...
$treatmentSteps = [
    ...
    ['step' => "02", 'title' => "Treatment Planning", 'desc' => "Personalized hormone therapy protocol.", 'image' => "https://img.freepik.com/free-photo/doctor-analyzing-x-ray-scan_1421-67.jpg"],
...
<?php
$whyChoose = [
    "Best hormone therapy doctor in India with 30+ years experience",
    ...
    "Affordable hormone therapy treatment costs in India",
];
?>
<?php
$videos = [
...
<div class="min-h-screen bg-white font-sans text-gray-800">
                    ...
                    <div class="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            <span class="inline-block py-1 px-3 rounded-full bg-medical-blue/10 text-medical-blue text-sm font-semibold mb-4">
                                Advanced Cancer Hormone Therapy
                            </span>
                            <h1 class="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Best <span class="text-medical-blue">Hormone Therapy Cost</span> in India
                            </h1>
                            <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                                Seeking affordable <strong>Hormone Therapy cost in India</strong>? Dr. Vijay Anand Reddy offers cutting-edge hormone therapy treatment with the latest hormonal agents and endocrine drugs at Apollo Cancer Centres Hyderabad. Get world-class cancer care at 60-70% lower cost than Western countries.
                            </p>
    ...
    <?php endforeach; ?>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Advanced Hormone Therapy Cancer Treatment in India</h2>
                        <p class="text-gray-600 text-lg">
                            Experience cutting-edge hormone therapy with the latest checkpoint inhibitors, CAR-T cell therapy, and personalized protocols. Dr. Vijay Anand Reddy offers the best Hormone Therapy cost in India with proven outcomes.
                        </p>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-12 items-start">
                        <div>
                            ...
                            <p class="text-gray-600 mb-6 leading-relaxed">
                                Hormone Therapy harnesses your body's hormones that fuel cancer growth. Dr. Vijay Anand Reddy, a leading <strong>hormone therapy specialist in India</strong>, offers advanced checkpoint inhibitors (anti-PD-1, anti-PD-L1, anti-CTLA-4), CAR-T cell therapy, and cancer vaccines tailored to each patient's unique cancer type and biomarker profile.
                            </p>
                    ...
                    <div class="mt-12 bg-medical-light p-8 rounded-2xl border border-medical-blue/20">
                        <h3 class="text-2xl font-bold text-medical-dark mb-6 text-center">Hormone Therapy Cost in India - Transparent Pricing</h3>
                        ...
                        <p class="text-center text-gray-600 mt-6">
                            <strong>Note:</strong> Exact Hormone Therapy cost in India depends on cancer type, drug selection, biomarker status, and treatment duration. Contact us for personalized cost estimate.
                        </p>
                    </div>
                    ...
                    <div class="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        <h3 class="text-2xl md:text-3xl font-bold text-white mb-4">
                            Schedule Your Hormone Therapy Consultation with Dr. Vijay Anand Reddy
                        </h3>
                        <p class="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Get expert guidance on advanced hormone therapy treatment in India. Book a personalized consultation to discuss your cancer treatment options and customized care plan.
                        </p>
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                                <img
                                    ...
                                    alt="Dr. Vijay Anand Reddy - Best Hormone Therapy Doctor in India"
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                                Dr. Vijay Anand Reddy is a distinguished oncologist with over 30 years of experience in providing world-class cancer care. As the Director of Apollo Cancer Centres, Hyderabad, he has pioneered advanced hormone therapy protocols and personalized cancer treatment approaches in India.
                            </p>
                            <p class="text-gray-600 mb-8 leading-relaxed">
                                He is renowned for his expertise in hormone therapy, checkpoint inhibitors, and CAR-T cell therapy. His commitment to personalized patient care, use of latest hormone therapy drugs, and evidence-based medicine has earned him recognition as one of India's leading hormone therapy specialists.
                            </p>
            ...
            <!-- Quote Section -->
            <?php $quoteId = 27; include 'quote_section.php'; ?>

            <!-- Treatment Process -->
            <section class="py-14 bg-medical-light">
                <div class="container mx-auto px-4">
                    <div class="text-center mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Our Hormone Therapy Treatment Process</h2>
                        <p class="text-gray-600 text-lg max-w-3xl mx-auto">
                            A systematic, patient-centric approach to hormone therapy treatment. Dr. Vijay Anand Reddy and his team follow a comprehensive 4-step process for optimal cancer treatment outcomes.
                        </p>
                    </div>
    ...
    <?php endforeach; ?>
                    ...
                    <div class="mt-12 text-center">
                        <div class="bg-white p-8 rounded-2xl shadow-xl border-t-4 border-medical-blue max-w-4xl mx-auto">
                            <h3 class="text-2xl md:text-3xl font-bold text-medical-dark mb-4">
                                Begin Your Hormone Therapy Treatment Journey Today
                            </h3>
                            <p class="text-gray-600 mb-6 text-lg">
                                Don't wait to start your journey to recovery. Dr. Vijay Anand Reddy and our expert team are ready to provide you with the best hormone therapy cancer treatment in India with world-class care.
                            </p>
                            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                <a href="#book-appointment" class="px-8 py-4 bg-medical-blue text-white rounded-lg font-semibold hover:bg-medical-dark transition shadow-lg flex items-center justify-center gap-2">
            ...
            <!-- Apollo Hospital Hormone Therapy Section -->
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Hormone Therapy at Apollo Cancer Centres India</h2>
                        <p class="text-gray-600 text-lg">
                            State-of-the-art hormone therapy infrastructure with world-class facilities, latest drugs, expert care, and the best hormone therapy doctor in India - Dr. Vijay Anand Reddy.
                        </p>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-12 mb-12">
                        <div>
                            <h3 class="text-2xl font-bold text-medical-dark mb-6 flex items-center gap-3">
                                <i class="far fa-hospital"></i> About Apollo Hormone Therapy Center
                            </h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">
                                Apollo Cancer Centres is equipped with India's most advanced hormone therapy facilities, offering comprehensive cancer treatment with the latest checkpoint inhibitors, CAR-T cell therapy, and cancer vaccines. Under the leadership of Dr. Vijay Anand Reddy, our center provides world-class hormone therapy care.
                            </p>
                            <p class="text-gray-600 mb-6 leading-relaxed">
                                Our hormone therapy program combines evidence-based medicine with a multidisciplinary team approach, ensuring each patient receives personalized treatment plans tailored to their specific biomarker profile and cancer type.
                            </p>
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start gap-2 text-gray-700 text-sm">
                                        ...
                                        Latest hormone therapy drugs (Pembrolizumab, Nivolumab, Atezolizumab)
                                    </li>
                                    <li class="flex items-start gap-2 text-gray-700 text-sm">
                                        <span class="w-1.5 h-1.5 bg-medical-blue rounded-full mt-2 flex-shrink-0"></span>
                        ...
                        <div class="relative h-full min-h-[400px]">
                            <img
                                ...
                                alt="Apollo Cancer Centre Hormone Therapy Facility"
                                class="rounded-2xl shadow-xl w-full h-full object-cover"
                            />
                        </div>
                    </div>
                    ...
                    <div class="mt-12">
                        <h3 class="text-2xl font-bold text-medical-dark mb-8 text-center">Advanced Hormone Therapy Facilities & Equipment</h3>
                        <div class="grid md:grid-cols-3 gap-6">
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <h4 class="font-bold text-medical-dark mb-3">Latest Hormone Therapy Drugs</h4>
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Dedicated hormone therapy infusion centers with comfortable recliners, trained nurses, and strict safety protocols for drug administration.
                                </p>
                            </div>
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Real-time monitoring during hormone therapy infusions with immediate intervention capabilities for any immune-related reactions.
                                </p>
                            </div>
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed">
                                    Next-generation sequencing and liquid biopsy facilities to identify optimal hormone therapy candidates and monitor treatment response.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                    Every hormone therapy plan is based on comprehensive biomarker testing including PD-L1 expression, TMB, MSI status, and tumor-infiltrating lymphocytes to identify best responders.
                                </p>
                            </div>
                            <div>
                                <h4 class="font-bold text-medical-dark mb-4 flex items-center gap-2">
                                ...
                                <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                    Our tumor board includes medical oncologists, immunologists, pathologists, radiologists, and support staff who collaborate for comprehensive hormone therapy care.
                                </p>
                            </div>
                            <div>
                                <h4 class="font-bold text-medical-dark mb-4 flex items-center gap-2">
                    ...
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        <div class="lg:w-1/2">
                            ...
                            <p class="text-gray-600 mb-8 text-lg">
                                As a pioneer in hormone therapy in India, Dr. Vijay Anand Reddy brings world-class expertise in hormonal agents and endocrine drugs. His dedication to evidence-based medicine and patient outcomes makes him the preferred choice for hormone therapy treatment.
                            </p>
                            <ul class="space-y-4">
    ...
    <?php endforeach; ?>
                    ...
                    <div class="mt-12 bg-medical-blue p-8 rounded-2xl shadow-xl text-center border-2 border-medical-blue">
                        <h3 class="text-2xl md:text-3xl font-bold text-white mb-4">
                            Experience World-Class Hormone Therapy Treatment in India
                        </h3>
                        <p class="text-white text-lg mb-6 max-w-2xl mx-auto">
                            Join thousands of patients who have trusted Dr. Vijay Anand Reddy, the best hormone therapy doctor in India, for advanced cancer treatment with proven results and compassionate care.
                        </p>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        ...
                        <p class="text-gray-600 text-lg">
                            We provide comprehensive support for international patients seeking affordable and high-quality hormone therapy treatment in India.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Initial video consultation to discuss hormone therapy options before travel."
                            },
                            {
                        ...
                        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                            <div class="text-white max-w-xl">
                                ...
                                <p class="text-blue-100 text-lg mb-6">
                                    Our dedicated International Patient Care team is available 24/7 to assist with treatment planning, cost estimates, and travel arrangements for hormone therapy in India.
                                </p>
                ...
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-4xl mx-auto mb-12">
                        ...
                        >
                            ...
                            <h2 class="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                                Most Reviewed & Highest Rated <span class="text-medical-blue">Hormone Therapy Doctor in India</span>
                            </h2>
                            <p class="text-gray-600 text-lg">
                                Dr. Vijay Anand Reddy has earned the trust of thousands of cancer patients through exceptional care, advanced hormone therapy treatments, and outstanding clinical outcomes.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                        ...
                        >
                            ...
                            <p class="text-xs text-gray-500 mt-1">For Hormone Therapy</p>
                        </div>
                    </div>
