...
<head>
    ...
    <title>PancreaticCancerPage - Dr. Vijay Anand Reddy</title>
    <!-- Google Fonts -->
...
<div class="min-h-screen bg-white font-sans text-gray-800">
                    ...
                    <div class="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            ...
                            <h1 class="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Best <span class="text-medical-blue">Pancreatic Cancer Treatment</span> in India
                            </h1>
    ...
    <?php endfor; ?>
                            ...
                            >
                                ...
                                <p class="text-gray-600 text-sm font-medium">Pancreatic Cancer Doctor in India</p>
                            </div>
    ...
    <?php endforeach; ?>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Comprehensive Pancreatic Cancer Treatment in India</h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-12 items-start">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">CT & MRI imaging</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    <div class="bg-medical-blue/10 p-3 rounded-lg text-medical-blue mt-1"><i class="fas fa-procedures"></i></div>
                                    <div>
                                        <h4 class="font-bold text-medical-dark">Whipple Procedure</h4>
                                        <p class="text-sm text-gray-500">Expert surgical care</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                        ...
                        <div class="relative h-full min-h-[400px]">
                            <img
                                src="/public/assets/condiotion-images/pancreatic-cancer.webp"
            ...
            <!-- Quote Section -->
            <?php $quoteId = 15; include 'quote_section.php'; ?>

            <!-- Treatment Process -->
            <section class="py-14 bg-medical-light">
                <div class="container mx-auto px-4">
                    <div class="text-center mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Our Pancreatic Cancer Treatment Process</h2>
    ...
    <?php endforeach; ?>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Pancreatic Cancer Treatment at Apollo Cancer Centres India</h2>
                        <p class="text-gray-600 text-lg">
                    ...
                    <div class="grid md:grid-cols-2 gap-12 mb-12">
                        <div>
                            <h3 class="text-2xl font-bold text-medical-dark mb-6 flex items-center gap-3">
                                <i class="far fa-hospital"></i> About Apollo Pancreatic Cancer Center
                            </h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">
                    ...
                    <div class="mt-12">
                        <h3 class="text-2xl font-bold text-medical-dark mb-8 text-center">Advanced Pancreatic Cancer Treatment Facilities & Equipment</h3>
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <h4 class="font-bold text-medical-dark mb-3">Expert Surgery</h4>
                                <p class="text-gray-600 text-sm leading-relaxed">
                ...
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-4xl mx-auto mb-12">
                        ...
                        >
                            ...
                            <h2 class="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                                Most Reviewed & Highest Rated <span class="text-medical-blue">Pancreatic Cancer Treatment Doctor in India</span>
                            </h2>
                            <p class="text-gray-600 text-lg">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                        ...
                        >
                            ...
                            <p class="text-xs text-gray-500 mt-1">For Pancreatic Cancer Treatment</p>
                        </div>
                    </div>
