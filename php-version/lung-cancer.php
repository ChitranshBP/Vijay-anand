...
<head>
    ...
    <title>LungCancerPage - Dr. Vijay Anand Reddy</title>
    <!-- Google Fonts -->
...
<?php
$subServices = [
    ['icon' => "FiMessageSquare", 'title' => "Online Consultation", 'desc' => "Initial video consultation to discuss treatment options and costs before travel."],
...
<div class="min-h-screen bg-white font-sans text-gray-800">
                    ...
                    <div class="flex flex-col lg:flex-row items-center mt-10 gap-12">
                        ...
                        >
                            ...
                            <h1 class="text-4xl lg:text-6xl font-bold text-medical-dark leading-tight mb-6">
                                Best <span class="text-medical-blue">Lung Cancer Treatment Cost</span> in India
                            </h1>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-8">
                                <div class="bg-white p-4 rounded-lg border border-medical-blue/20 shadow-sm">
                                    <div class="text-3xl font-bold text-medical-blue mb-1">60-70%</div>
                                    <p class="text-xs text-gray-600">Lower Cost Than Abroad</p>
                                </div>
                                <div class="bg-white p-4 rounded-lg border border-medical-blue/20 shadow-sm">
    ...
    <?php endfor; ?>
                            ...
                            >
                                ...
                                <p class="text-gray-600 text-sm font-medium">Lung Cancer Doctor in India</p>
                            </div>
    ...
    <?php endforeach; ?>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Comprehensive Lung Cancer Treatment Cost in India</h2>
                    ...
                    <div class="grid md:grid-cols-2 gap-12 items-start">
                        <div>
                            <h3 class="text-2xl font-bold text-medical-dark mb-6 flex items-center gap-3">
                                <FaLungs class="text-medical-blue" /> Overview
                            </h3>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">CT, PET scans & biopsies</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">VATS & robotic surgery</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">IMRT, IGRT & SBRT</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">EGFR & ALK inhibitors</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
                                    <div class="bg-medical-blue/10 p-3 rounded-lg text-medical-blue mt-1"><i class="fas fa-shield-alt"></i></div>
                                    <div>
                                        <h4 class="font-bold text-medical-dark">Affordable Costs</h4>
                                        <p class="text-sm text-gray-500">60-70% cheaper</p>
                                    </div>
                                </div>
                                <div class="bg-medical-light p-4 rounded-lg border border-medical-blue/20 flex items-start gap-3 shadow-sm hover:shadow-lg transition">
            ...
            <!-- Quote Section -->
            <?php $quoteId = 11; include 'quote_section.php'; ?>

            <!-- Treatment Process -->
            <section class="py-14 bg-medical-light">
                <div class="container mx-auto px-4">
                    <div class="text-center mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Our Lung Cancer Treatment Process</h2>
    ...
    <?php endforeach; ?>
            ...
            <section class="py-16 bg-white">
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-3xl mx-auto mb-12">
                        <h2 class="text-3xl md:text-4xl font-bold text-medical-dark mb-4">Affordable Lung Cancer Treatment Cost at Apollo Cancer Centres India</h2>
                        <p class="text-gray-600 text-lg">
                    ...
                    <div class="grid md:grid-cols-2 gap-12 mb-12">
                        <div>
                            <h3 class="text-2xl font-bold text-medical-dark mb-6 flex items-center gap-3">
                                <i class="far fa-hospital"></i> About Apollo Lung Cancer Center
                            </h3>
                            <p class="text-gray-600 mb-6 leading-relaxed">
                    ...
                    <div class="mt-12">
                        <h3 class="text-2xl font-bold text-medical-dark mb-8 text-center">Advanced Lung Cancer Treatment Facilities & Equipment</h3>
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div class="bg-medical-light p-6 rounded-xl border border-medical-blue/20 hover:shadow-lg transition">
                                ...
                                <h4 class="font-bold text-medical-dark mb-3">Molecular Testing</h4>
                                <p class="text-gray-600 text-sm leading-relaxed">
                    ...
                    <div class="flex flex-col lg:flex-row gap-16 items-center">
                        ...
                        <div class="lg:w-1/2 grid grid-cols-2 gap-4">
                            ...
                            <div class="bg-medical-blue/20 p-6 rounded-2xl text-center shadow-md hover:shadow-xl transition border border-medical-blue/40">
                                ...
                                <div class="text-3xl font-bold text-medical-blue mb-1">60-70%</div>
                                <h4 class="font-bold text-medical-dark text-sm">Cost Savings</h4>
                            </div>
                ...
                <div class="container mx-auto px-4">
                    <div class="text-center max-w-4xl mx-auto mb-12">
                        ...
                        >
                            ...
                            <h2 class="text-3xl md:text-5xl font-bold text-medical-dark mb-4">
                                Most Reviewed & Highest Rated <span class="text-medical-blue">Lung Cancer Treatment Doctor in India</span>
                            </h2>
                            <p class="text-gray-600 text-lg">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
                        ...
                        >
                            ...
                            <p class="text-xs text-gray-500 mt-1">For Lung Cancer Treatment</p>
                        </div>
                    </div>
